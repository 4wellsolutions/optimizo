...
@section('content')
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-8">
            <article class="bg-white rounded-3xl md:rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100">
                {{-- Header Image --}}
                @if($post->featured_image)
                    <div class="aspect-video lg:aspect-[21/9] w-full overflow-hidden">
                ...
                <div class="p-6 md:p-10 lg:p-12">
                    ...
                    <h1 class="text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">
                        {{ $post->title }}
                    </h1>
