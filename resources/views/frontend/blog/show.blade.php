...
@section('content')
            ...
            <div class="lg:col-span-8">
                <article
                    ...
                    @if($post->featured_image)
                        <div class="aspect-video lg:aspect-[21/9] w-full overflow-hidden bg-gray-100">
                    ...
                    <div class="p-6 md:p-10 lg:p-12">
                        ...
                        <div
                            class="prose prose-lg lg:prose-xl prose-indigo max-w-none text-gray-700/90 blog-content font-medium">
                            {!! $post->content !!}
                        </div>
    ...
    <style>
        .blog-content {
            @apply text-gray-700/90 leading-[1.8];
        }

        .blog-content h2 {
            @apply text-3xl md:text-4xl font-black text-gray-900 mt-12 mb-6 tracking-tight leading-tight;
        }

        .blog-content h3 {
            @apply text-2xl md:text-3xl font-black text-gray-900 mt-10 mb-5 tracking-tight leading-tight;
        }

        .blog-content h4 {
            @apply text-xl md:text-2xl font-black text-gray-900 mt-8 mb-4 tracking-tight leading-tight;
        }
        ...
        .blog-content ul,
        .blog-content ol {
            @apply mb-8 ml-6 md:ml-8 space-y-3;
        }
        ...
        .blog-content ol {
            @apply list-decimal marker:text-indigo-600 marker:font-bold;
        }
        ...
        .blog-content img {
            @apply rounded-2xl md:rounded-[2rem] shadow-xl my-10 w-full border border-gray-100;
        }

        .blog-content blockquote {
            @apply border-l-[6px] border-indigo-600 pl-6 md:pl-8 py-4 italic text-lg md:text-xl font-medium text-gray-800 my-10 bg-indigo-50/30 rounded-r-2xl;
        }

        .blog-content pre {
            @apply bg-gray-900 text-gray-100 p-6 md:p-8 rounded-2xl overflow-x-auto my-10 shadow-lg;
        }
        ...
        /* Added spacing for common inner elements */
        .blog-content > * + h2,
        .blog-content > * + h3,
        .blog-content > * + h4 {
            @apply mt-14;
