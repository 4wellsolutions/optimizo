...
@section('title', 'SEO Tools - Free Professional SEO & Analysis Tools | Optimizo')
@section('meta_description', 'Free SEO tools including meta tag analyzers, keyword generators, and optimization tools. 100% free, no registration required.')
                    ...
                    @foreach($subcategoryTools as $tool)
                        <a href="{{ localeRoute($tool->route_name) }}"
                            ...
                            <div class="flex items-center gap-4 mb-4">
                                <div
                                    class="w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
