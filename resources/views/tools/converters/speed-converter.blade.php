...
@section('title', __tool('speed-converter', 'seo.title'))
@section('meta_description', __tool('speed-converter', 'seo.description'))
@section('meta_keywords', __tool('speed-converter', 'seo.keywords'))
        ...
        <div class="bg-white rounded-3xl p-6 md:p-10 shadow-2xl border border-gray-100 mb-12 relative overflow-hidden">
            ...
            <div class="grid md:grid-cols-7 gap-6 items-center">
                ...
                <div class="md:col-span-3 space-y-2">
                    <label for="fromValue"
                        class="block text-sm font-bold text-gray-700 uppercase tracking-wide">{{ __tool('speed-converter', 'form.from_label') }}</label>
                    <div class="relative">
                    ...
                    <select id="fromUnit" onchange="convert('from')"
                        ...
                        <option value="kph" selected>{{ __tool('speed-converter', 'form.unit_kph') }}</option>
                        <option value="mph">{{ __tool('speed-converter', 'form.unit_mph') }}</option>
                        <option value="mps">{{ __tool('speed-converter', 'form.unit_mps') }}</option>
                        <option value="knot">{{ __tool('speed-converter', 'form.unit_knot') }}</option>
                        <option value="mach">{{ __tool('speed-converter', 'form.unit_mach') }}</option>
                    </select>
                </div>
                ...
                {{-- To Section --}}
                <div class="md:col-span-3 space-y-2">
                    <label for="toValue" class="block text-sm font-bold text-gray-700 uppercase tracking-wide">{{ __tool('speed-converter', 'form.to_label') }}</label>
                    <div class="relative">
                    ...
                    <select id="toUnit" onchange="convert('from')"
                        class="block w-full p-3 bg-gray-50 border border-gray-200 rounded-xl font-medium text-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all cursor-pointer hover:bg-gray-100">
                        <option value="kph">{{ __tool('speed-converter', 'form.unit_kph') }}</option>
                        <option value="mph" selected>{{ __tool('speed-converter', 'form.unit_mph') }}</option>
                        <option value="mps">{{ __tool('speed-converter', 'form.unit_mps') }}</option>
                        <option value="knot">{{ __tool('speed-converter', 'form.unit_knot') }}</option>
        ...
        <div class="space-y-12">
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2">{{ __tool('speed-converter', 'content.feature1_title') }}</h3>
                    <p class="text-gray-600">{{ __tool('speed-converter', 'content.feature1_desc') }}</p>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2">{{ __tool('speed-converter', 'content.feature2_title') }}</h3>
                    <p class="text-gray-600">{{ __tool('speed-converter', 'content.feature2_desc') }}</p>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2">{{ __tool('speed-converter', 'content.feature3_title') }}</h3>
                    <p class="text-gray-600">{{ __tool('speed-converter', 'content.feature3_desc') }}</p>
                </div>
            </div>

            <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-lg">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">{{ __tool('speed-converter', 'content.main_title') }}</h2>
                <div class="prose prose-indigo max-w-none text-gray-600">
                    <p>{{ __tool('speed-converter', 'content.description_p1') }}</p>
                    <p class="mt-4">{{ __tool('speed-converter', 'content.description_p2') }}</p>

                    <h3 class="text-xl font-bold text-gray-900 mt-8 mb-4">{{ __tool('speed-converter', 'content.usage_examples_title') }}</h3>
                    <div class="grid md:grid-cols-2 gap-6">
                        <ul class="list-disc list-inside space-y-2">
                            <li>{!! __tool('speed-converter', 'content.usage_1') !!}</li>
                            <li>{!! __tool('speed-converter', 'content.usage_2') !!}</li>
                            <li>{!! __tool('speed-converter', 'content.usage_3') !!}</li>
                        </ul>
                        <ul class="list-disc list-inside space-y-2">
                            <li>{!! __tool('speed-converter', 'content.usage_4') !!}</li>
                            <li>{!! __tool('speed-converter', 'content.usage_5') !!}</li>
                            <li>{!! __tool('speed-converter', 'content.usage_6') !!}</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-indigo-50 to-white rounded-3xl p-8 border border-indigo-100 shadow-lg">
                <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                    ...
                    {{ __tool('speed-converter', 'content.faq_title') }}
                </h2>
                <div class="space-y-6">
                    <div>
                        <h3 class="font-bold text-gray-900 mb-2">{{ __tool('speed-converter', 'content.faq_q1') }}</h3>
                        <p class="text-gray-600 text-sm leading-relaxed">{{ __tool('speed-converter', 'content.faq_a1') }}</p>
                    </div>
                    <div>
                        <h3 class="font-bold text-gray-900 mb-2">{{ __tool('speed-converter', 'content.faq_q2') }}</h3>
                        <p class="text-gray-600 text-sm leading-relaxed">{{ __tool('speed-converter', 'content.faq_a2') }}</p>
                    </div>
                    <div>
                        <h3 class="font-bold text-gray-900 mb-2">{{ __tool('speed-converter', 'content.faq_q3') }}</h3>
                        <p class="text-gray-600 text-sm leading-relaxed">{{ __tool('speed-converter', 'content.faq_a3') }}</p>
                    </div>
                    <div>
                        <h3 class="font-bold text-gray-900 mb-2">{{ __tool('speed-converter', 'content.faq_q4') }}</h3>
                        <p class="text-gray-600 text-sm leading-relaxed">{{ __tool('speed-converter', 'content.faq_a4') }}</p>
                    </div>
                </div>
            </div>
        </div>
