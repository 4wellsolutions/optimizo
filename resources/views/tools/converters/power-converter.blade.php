...
@section('title', __tool('power-converter', 'seo.title'))
@section('meta_description', __tool('power-converter', 'seo.description'))
@section('meta_keywords', __tool('power-converter', 'seo.keywords'))
