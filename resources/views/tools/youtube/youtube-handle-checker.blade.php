...
@section('title', __tool('youtube-handle-checker', 'seo.title', $tool->meta_title))
@section('meta_description', __tool('youtube-handle-checker', 'seo.description', $tool->meta_description))
...
@section('content')
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-red-200 mb-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-6 text-center">{{ __tool('youtube-handle-checker', 'form.title') }}</h2>
            <form id="handleForm">
                @csrf
                <div class="mb-6">
                    <label for="handle" class="form-label text-base">{{ __tool('youtube-handle-checker', 'form.handle_label') }}</label>
                    <div class="relative">
                        <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 font-semibold text-lg">@</span>
                        <input type="text" id="handle" name="handle" class="form-input pl-10" placeholder="{{ __tool('youtube-handle-checker', 'form.handle_placeholder') }}"
            ...
            <div id="resultsSection" class="hidden mt-8">
                <div id="resultCard" class="rounded-2xl p-8 text-center shadow-xl">
                    ...
                    <div id="suggestions" class="hidden mt-6">
                        <p class="text-sm font-semibold mb-3">{{ __tool('youtube-handle-checker', 'js.try_alternatives') }}</p>
        ...
        <div
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-4xl font-black text-gray-900 mb-3">{{ __tool('youtube-handle-checker', 'content.main_title') }}</h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">{{ __tool('youtube-handle-checker', 'content.main_subtitle') }}</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-10">
                <div
                    ...
                    <h3 class="font-bold text-xl text-gray-900 mb-2">{{ __tool('youtube-handle-checker', 'content.feature1_title') }}</h3>
                ...
                <div
                    ...
                    <h3 class="font-bold text-xl text-gray-900 mb-2">{{ __tool('youtube-handle-checker', 'content.feature2_title') }}</h3>
            ...
            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('youtube-handle-checker', 'content.faq_title') }}</h3>
            <div class="space-y-4">
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('youtube-handle-checker', 'content.faq_q1') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('youtube-handle-checker', 'content.faq_a1') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('youtube-handle-checker', 'content.faq_q2') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('youtube-handle-checker', 'content.faq_a2') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('youtube-handle-checker', 'content.faq_q3') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('youtube-handle-checker', 'content.faq_a3') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('youtube-handle-checker', 'content.faq_q4') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('youtube-handle-checker', 'content.faq_a4') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('youtube-handle-checker', 'content.faq_q5') }}</h4>
