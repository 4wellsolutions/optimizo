        ...
        <div class="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 md:p-12 overflow-hidden relative">
            ...
            <div class="relative z-10">
                <h2 class="text-2xl font-bold text-gray-800 mb-8 flex items-center gap-3">
                    ...
                    {{ __tool('unix-timestamp-to-date', 'form.title') }}
                </h2>
                ...
                <div class="space-y-6">
                    <div class="relative">
                        <input type="text" id="unixInput"
                            ...
                            placeholder="{{ __tool('unix-timestamp-to-date', 'form.placeholder') }}" value="{{ time() }}">
                        <button onclick="setInputToNow()"
                            ...
                            {{ __tool('unix-timestamp-to-date', 'form.button_now') }}
                        </button>
                    </div>
                    ...
                    <button onclick="convertUnix()"
                        ...
                        {{ __tool('unix-timestamp-to-date', 'form.button_convert') }}
                    </button>
                        ...
                        <div class="grid gap-4">
                            <div class="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                <div class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">
                                    {{ __tool('unix-timestamp-to-date', 'form.result_gmt') }}
                                </div>
                            ...
                            <div class="p-4 bg-green-50 rounded-xl border border-green-100">
                                <div class="text-xs font-bold text-green-600 uppercase tracking-widest mb-1">
                                    {{ __tool('unix-timestamp-to-date', 'form.result_local') }}
                                </div>
                                <div id="resLocal" class="font-mono text-lg text-green-900 font-bold break-all"></div>
                            </div>
                            <div class="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                <div class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">
                                    {{ __tool('unix-timestamp-to-date', 'form.result_iso') }}
                                </div>
    ...
    <article class="max-w-4xl mx-auto prose prose-lg prose-green mb-20 px-4">
        <div class="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
            <h2 class="text-3xl font-extrabold text-gray-900 mb-6 font-display">
                {{ __tool('unix-timestamp-to-date', 'content.hero_title') }}
            </h2>
            <p class="lead text-gray-600">{{ __tool('unix-timestamp-to-date', 'content.hero_description') }}</p>
            ...
            <h3 class="flex items-center gap-3 text-2xl font-bold text-gray-900 mt-12 mb-6">
                ...
                {{ __tool('unix-timestamp-to-date', 'content.formats_title') }}
            </h3>
            ...
            <div class="space-y-6 not-prose mb-12">
                <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 hover:border-green-200 transition-colors">
                    <h4 class="font-bold text-gray-900 flex justify-between items-center mb-2">
                        <span>{{ __tool('unix-timestamp-to-date', 'content.format_gmt_title') }}</span>
                        <span class="text-xs font-normal px-2 py-1 bg-gray-200 rounded text-gray-600">RFC 2822</span>
                    </h4>
                    <code
                        class="block bg-white border border-gray-200 rounded p-2 mb-2 text-sm text-green-700 font-mono">{{ __tool('unix-timestamp-to-date', 'content.format_gmt_example') }}</code>
                    <p class="text-sm text-gray-600 mb-0">{{ __tool('unix-timestamp-to-date', 'content.format_gmt_desc') }}</p>
                </div>

                <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 hover:border-green-200 transition-colors">
                    <h4 class="font-bold text-gray-900 flex justify-between items-center mb-2">
                        <span>{{ __tool('unix-timestamp-to-date', 'content.format_iso_title') }}</span>
                        <span class="text-xs font-normal px-2 py-1 bg-gray-200 rounded text-gray-600">ISO 8601</span>
                    </h4>
                    <code
                        class="block bg-white border border-gray-200 rounded p-2 mb-2 text-sm text-green-700 font-mono">{{ __tool('unix-timestamp-to-date', 'content.format_iso_example') }}</code>
                    <p class="text-sm text-gray-600 mb-0">{{ __tool('unix-timestamp-to-date', 'content.format_iso_desc') }}</p>
                </div>

                <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 hover:border-green-200 transition-colors">
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('unix-timestamp-to-date', 'content.format_local_title') }}</h4>
                    <code
                        class="block bg-white border border-gray-200 rounded p-2 mb-2 text-sm text-green-700 font-mono">{{ __tool('unix-timestamp-to-date', 'content.format_local_example') }}</code>
                    <p class="text-sm text-gray-600 mb-0">{{ __tool('unix-timestamp-to-date', 'content.format_local_desc') }}</p>
                </div>
            </div>
            ...
            <div
                ...
                <div>
                    <h3 class="mt-0 text-blue-900">{{ __tool('unix-timestamp-to-date', 'content.reverse_title') }}</h3>
                    <p class="text-blue-800 mb-4">{{ __tool('unix-timestamp-to-date', 'content.reverse_description') }}</p>
                    <a href="{{ url('tools/date-to-unix-timestamp') }}"
                        ...
                        {{ __tool('unix-timestamp-to-date', 'content.reverse_button') }} &rarr;
                    </a>
                </div>
            </div>

            <div class="mt-12 p-6 border-l-4 border-yellow-400 bg-yellow-50 rounded-r-xl">
                <h4 class="font-bold text-yellow-800 mt-0">{{ __tool('unix-timestamp-to-date', 'content.tip_title') }}</h4>
                <p class="text-yellow-700 mb-0 leading-relaxed">{{ __tool('unix-timestamp-to-date', 'content.tip_desc') }}</p>
            </div>
        </div>
    </article>
