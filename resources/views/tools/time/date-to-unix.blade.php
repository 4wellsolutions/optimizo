            ...
            <div class="relative z-10">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label
                                class="block text-sm font-semibold text-gray-700">{{ __tool('date-to-unix', 'form.date_label') }}</label>
                            <input type="date" id="dateInput"
                                class="w-full rounded-xl border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 py-3 px-4">
                        </div>
                        <div class="space-y-2">
                            <label
                                class="block text-sm font-semibold text-gray-700">{{ __tool('date-to-unix', 'form.time_label') }}</label>
                    ...
                    <div id="resultContainer" class="hidden pt-8 border-t border-gray-100 text-center animate-fade-in-up">
                        <p class="text-sm font-bold text-gray-400 uppercase tracking-widest mb-2">
                            {{ __tool('date-to-unix', 'form.result_title') }}</p>
                        <div id="unixResult"
                            ...
                            title="{{ __tool('date-to-unix', 'click_to_copy') }}"></div>
    ...
    <article class="max-w-4xl mx-auto prose prose-lg prose-indigo mb-20 px-4">
        <div class="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
            <h2 class="text-3xl font-extrabold text-gray-900 mb-6 font-display">
                {{ __tool('date-to-unix', 'content.hero_title') }}</h2>
