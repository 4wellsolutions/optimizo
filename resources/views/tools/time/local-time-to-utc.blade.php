...
@section('content')
    ...
    <div class="max-w-4xl mx-auto mb-16 px-4">
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="bg-gray-50 px-8 py-6 border-b border-gray-100">
                <h3 class="text-xl font-bold text-gray-800">{{ __tool('local-time-to-utc', 'form.title') }}</h3>
                <p class="text-sm text-gray-500">{{ __tool('local-time-to-utc', 'form.subtitle') }}</p>
            </div>
            ...
            <div class="p-8">
                <div class="grid md:grid-cols-2 gap-6 items-end">
                    <div class="w-full">
                        <label
                            class="block text-sm font-bold text-gray-700 mb-2">{{ __tool('local-time-to-utc', 'form.label') }}</label>
                ...
                <div class="mt-6 flex justify-end">
                    <button onclick="convertLocalToUtc()"
                        ...
                        {{ __tool('local-time-to-utc', 'form.button') }}
                    </button>
                </div>
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                        <div class="text-center md:text-left">
                            <div class="text-xs font-bold text-blue-600 uppercase tracking-widest mb-1">
                                {{ __tool('local-time-to-utc', 'form.timezone_label') }} <span id="userTimezone"
                        ...
                        <div class="text-center md:text-right">
                            <div class="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">
                                {{ __tool('local-time-to-utc', 'form.result_title') }}</div>
                            <div id="displayUtc"
                                class="text-3xl font-mono font-black text-gray-900 tracking-tight select-all"></div>
                            <div class="text-sm text-gray-500">{{ __tool('local-time-to-utc', 'form.result_subtitle') }}</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 mb-20">
        <div class="grid md:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
                ...
                <h4 class="font-bold text-gray-900 mb-2">{{ __tool('local-time-to-utc', 'features.instant_title') }}</h4>
                <p class="text-sm text-gray-600">{{ __tool('local-time-to-utc', 'features.instant_desc') }}</p>
            </div>
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
                ...
                <h4 class="font-bold text-gray-900 mb-2">{{ __tool('local-time-to-utc', 'features.timezone_title') }}</h4>
                <p class="text-sm text-gray-600">{{ __tool('local-time-to-utc', 'features.timezone_desc') }}</p>
            </div>
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
                ...
                <h4 class="font-bold text-gray-900 mb-2">{{ __tool('local-time-to-utc', 'features.accurate_title') }}</h4>
                <p class="text-sm text-gray-600">{{ __tool('local-time-to-utc', 'features.accurate_desc') }}</p>
            </div>
        </div>
    </div>
    ...
    <article class="max-w-4xl mx-auto prose prose-lg prose-blue px-4 mb-20">
        <h2 class="font-display text-gray-900">{{ __tool('local-time-to-utc', 'content.why_title') }}</h2>
        <p>{{ __tool('local-time-to-utc', 'content.why_desc') }}</p>

        <h3>{{ __tool('local-time-to-utc', 'content.utc_standard_title') }}</h3>
        <p>{{ __tool('local-time-to-utc', 'content.utc_standard_intro') }}</p>
        <ul>
            <li><strong>{{ __tool('local-time-to-utc', 'content.timezone_reason') }}</strong></li>
            <li><strong>{{ __tool('local-time-to-utc', 'content.dst_reason') }}</strong></li>
            <li><strong>{{ __tool('local-time-to-utc', 'content.political_reason') }}</strong></li>
        </ul>
        <p>{{ __tool('local-time-to-utc', 'content.utc_immunity') }}</p>

        <h3>{{ __tool('local-time-to-utc', 'content.applications_title') }}</h3>
        <div class="not-prose grid gap-4">
            <div class="bg-gray-50 p-4 rounded-lg">
                <strong class="block text-gray-900">{{ __tool('local-time-to-utc', 'content.aviation_title') }}</strong>
                <span class="text-gray-600">{{ __tool('local-time-to-utc', 'content.aviation_desc') }}</span>
            </div>
            <div class="bg-gray-50 p-4 rounded-lg">
                <strong class="block text-gray-900">{{ __tool('local-time-to-utc', 'content.servers_title') }}</strong>
                <span class="text-gray-600">{{ __tool('local-time-to-utc', 'content.servers_desc') }}</span>
            </div>
            <div class="bg-gray-50 p-4 rounded-lg">
                <strong class="block text-gray-900">{{ __tool('local-time-to-utc', 'content.events_title') }}</strong>
                <span class="text-gray-600">{{ __tool('local-time-to-utc', 'content.events_desc') }}</span>
            </div>
        </div>
    </article>
