...
@section('content')
    <!-- Hero Section -->
    <div
        class="relative overflow-hidden bg-gradient-to-br from-green-500 via-emerald-500 to-teal-500 rounded-3xl p-8 md:p-12 mb-12 shadow-2xl">
        ...
        <div class="relative z-10 text-center">
            <div
                class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-2xl shadow-2xl mb-8 transform hover:scale-105 transition-transform duration-300">
                <!-- Icon: Google Sheets Logo representation (Green grid) -->
