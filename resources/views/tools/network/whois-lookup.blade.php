        ...
        <form id="whoisForm">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="domain" name="domain"
                    class="w-full p-3 border-2 border-teal-500 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                    placeholder="example.com" required>
            </div>

            <button type="submit" class="px-6 py-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700 font-semibold">
                Lookup WHOIS
            </button>
        </form>
