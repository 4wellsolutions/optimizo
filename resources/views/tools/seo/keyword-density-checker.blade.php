...
@section('title', __tool('keyword-density-checker', 'seo.title', $tool->meta_title))
@section('meta_description', __tool('keyword-density-checker', 'seo.description', $tool->meta_description))
