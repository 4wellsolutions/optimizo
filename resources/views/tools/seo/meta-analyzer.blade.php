...
@section('title', __tool('meta-analyzer', 'meta.title'))
@section('meta_description', __tool('meta-analyzer', 'meta.description'))
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-green-200 mb-8">
            ...
            <div id="results" class="hidden">
                <h3 class="text-2xl font-bold text-gray-900 mb-6">{{ __tool('meta-analyzer', 'results.title') }}</h3>

                <!-- Title Tag -->
                <div class="mb-6">
                    <div class="flex items-center justify-between mb-2">
                        <h4 class="font-bold text-lg text-gray-900">{{ __tool('meta-analyzer', 'results.title_tag') }}</h4>
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 border-2 border-gray-200">
                        ...
                        <div class="text-sm text-gray-600">
                            {{ __tool('meta-analyzer', 'results.length') }}: <span id="titleLength"
                                class="font-bold"></span> {{ __tool('meta-analyzer', 'results.characters') }}
                ...
                <div class="mb-6">
                    <div class="flex items-center justify-between mb-2">
                        <h4 class="font-bold text-lg text-gray-900">
                            {{ __tool('meta-analyzer', 'results.meta_description') }}
                        </h4>
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 border-2 border-gray-200">
                        ...
                        <div class="text-sm text-gray-600">
                            {{ __tool('meta-analyzer', 'results.length') }}: <span id="descLength" class="font-bold"></span>
                            {{ __tool('meta-analyzer', 'results.characters') }}
        ...
        <div
            ...
            <p class="text-gray-700 leading-relaxed text-lg mb-8">
                {{ __tool('meta-analyzer', 'content.intro') }}
            </p>

            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('meta-analyzer', 'content.what_are_title') }}</h3>
            <p class="text-gray-700 leading-relaxed mb-6">
                {{ __tool('meta-analyzer', 'content.what_are_desc') }}
            </p>
            ...
            <div class="bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-200 rounded-2xl p-8 mb-10">
                <h4 class="font-bold text-yellow-900 mb-3 flex items-center gap-3 text-xl">
                    ...
                    {{ __tool('meta-analyzer', 'content.common_mistakes_title') }}
                </h4>
                <ul class="text-yellow-800 leading-relaxed space-y-2">
                    <li>{{ __tool('meta-analyzer', 'content.mistake_1') }}</li>
                    <li>{{ __tool('meta-analyzer', 'content.mistake_2') }}</li>
                    <li>{{ __tool('meta-analyzer', 'content.mistake_3') }}</li>
                    <li>{{ __tool('meta-analyzer', 'content.mistake_4') }}</li>
                    <li>{{ __tool('meta-analyzer', 'content.mistake_5') }}</li>
                    <li>{{ __tool('meta-analyzer', 'content.mistake_6') }}</li>
                </ul>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
                ...
                <div
                    ...
                    <div class="text-3xl mb-3">👆</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('meta-analyzer', 'benefits.b2_title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('meta-analyzer', 'benefits.b2_desc') }}</p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-blue-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">📱</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('meta-analyzer', 'benefits.b3_title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('meta-analyzer', 'benefits.b3_desc') }}</p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-purple-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">🔍</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('meta-analyzer', 'benefits.b4_title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('meta-analyzer', 'benefits.b4_desc') }}</p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-pink-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">⚡</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('meta-analyzer', 'features.f2_title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('meta-analyzer', 'features.f2_desc') }}</p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-indigo-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">🏆</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('meta-analyzer', 'features.f3_title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('meta-analyzer', 'features.f3_desc') }}</p>
                </div>
            </div>

            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('meta-analyzer', 'faq.title') }}</h3>
            <div class="space-y-4">
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('meta-analyzer', 'faq.q1') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('meta-analyzer', 'faq.a1') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('meta-analyzer', 'faq.q2') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('meta-analyzer', 'faq.a2') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('meta-analyzer', 'faq.q3') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('meta-analyzer', 'faq.a3') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('meta-analyzer', 'faq.q4') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('meta-analyzer', 'faq.a4') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('meta-analyzer', 'faq.q5') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('meta-analyzer', 'faq.a5') }}</p>
                </div>
            </div>
        </div>
    </div>
