    ...
    <div class="max-w-5xl mx-auto">
            ...
            <div id="results" class="hidden">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border-2 border-purple-200">
                        <div class="text-sm text-gray-600 mb-1">{{ __tool('keyword-density', 'results.total_words') }}</div>
                    ...
                    <div class="bg-gradient-to-br from-pink-50 to-red-50 rounded-xl p-4 border-2 border-pink-200">
                        <div class="text-sm text-gray-600 mb-1">{{ __tool('keyword-density', 'results.unique_words') }}
                        </div>
                    ...
                    <div class="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl p-4 border-2 border-red-200">
                        <div class="text-sm text-gray-600 mb-1">{{ __tool('keyword-density', 'results.sentences') }}</div>
                    ...
                    <div class="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-xl p-4 border-2 border-orange-200">
                        <div class="text-sm text-gray-600 mb-1">{{ __tool('keyword-density', 'results.paragraphs') }}</div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div class="bg-gradient-to-br from-yellow-50 to-green-50 rounded-xl p-4 border-2 border-yellow-200">
                        <div class="text-sm text-gray-600 mb-1">{{ __tool('keyword-density', 'results.long_sentences') }}
                        </div>
                    ...
                    <div class="bg-gradient-to-br from-green-50 to-teal-50 rounded-xl p-4 border-2 border-green-200">
                        <div class="text-sm text-gray-600 mb-1">{{ __tool('keyword-density', 'results.short_sentences') }}
                        </div>
                    ...
                    <div class="bg-gradient-to-br from-teal-50 to-blue-50 rounded-xl p-4 border-2 border-teal-200">
                        <div class="text-sm text-gray-600 mb-1">{{ __tool('keyword-density', 'results.top_keyword') }}</div>
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border-2 border-blue-200">
                        <div class="text-sm text-gray-600 mb-1">{{ __tool('keyword-density', 'results.top_density') }}</div>
        ...
        <div
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-4xl font-black text-gray-900 mb-3">{{ __tool('keyword-density', 'content.main_title') }}
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">{{ __tool('keyword-density', 'content.main_subtitle') }}
                </p>
            </div>

            <p class="text-gray-700 leading-relaxed text-lg mb-8">
                {{ __tool('keyword-density', 'content.intro') }}
            </p>

            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('keyword-density', 'content.what_is_title') }}</h3>
            <p class="text-gray-700 leading-relaxed mb-6">
                {{ __tool('keyword-density', 'content.what_is_text') }}
            </p>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-cyan-50 border-2 border-blue-200 rounded-2xl p-8 mb-10">
                <h4 class="font-bold text-blue-900 mb-3 flex items-center gap-3 text-xl">
                    ...
                    {{ __tool('keyword-density', 'content.guidelines_title') }}
                </h4>
                <ul class="text-blue-800 leading-relaxed space-y-2">
                    <li>{!! __tool('keyword-density', 'guidelines.g1') !!}</li>
                    <li>{!! __tool('keyword-density', 'guidelines.g2') !!}</li>
                    <li>{!! __tool('keyword-density', 'guidelines.g3') !!}</li>
                    <li>{!! __tool('keyword-density', 'guidelines.g4') !!}</li>
                    <li>{!! __tool('keyword-density', 'guidelines.g5') !!}</li>
                </ul>
            </div>

            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('keyword-density', 'content.why_use_title') }}</h3>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-purple-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">🔍</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('keyword-density', 'features.f1_title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('keyword-density', 'features.f1_desc') }}</p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-pink-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">📝</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('keyword-density', 'features.f2_title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('keyword-density', 'features.f2_desc') }}</p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-red-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">🛡️</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('keyword-density', 'features.f3_title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('keyword-density', 'features.f3_desc') }}</p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-orange-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">📊</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('keyword-density', 'features.f4_title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('keyword-density', 'features.f4_desc') }}</p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-yellow-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">✍️</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('keyword-density', 'features.f5_title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('keyword-density', 'features.f5_desc') }}</p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-green-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">🎯</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('keyword-density', 'features.f6_title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('keyword-density', 'features.f6_desc') }}</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 border-2 border-gray-200 mb-8">
                <ul class="space-y-3 text-gray-700">
                    <li class="flex items-start gap-3">
                        ...
                        <span>{!! __tool('keyword-density', 'best_practices.bp1') !!}</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-green-600 font-bold text-xl">✓</span>
                        <span>{!! __tool('keyword-density', 'best_practices.bp2') !!}</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-green-600 font-bold text-xl">✓</span>
                        <span>{!! __tool('keyword-density', 'best_practices.bp3') !!}</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-green-600 font-bold text-xl">✓</span>
                        <span>{!! __tool('keyword-density', 'best_practices.bp4') !!}</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-red-600 font-bold text-xl">✗</span>
                        <span>{!! __tool('keyword-density', 'best_practices.bp5') !!}</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-red-600 font-bold text-xl">✗</span>
                        <span>{!! __tool('keyword-density', 'best_practices.bp6') !!}</span>
                    </li>
                </ul>
            </div>

            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('keyword-density', 'content.faq_title') }}</h3>
            <div class="space-y-4">
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('keyword-density', 'faq.q1') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('keyword-density', 'faq.a1') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('keyword-density', 'faq.q2') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('keyword-density', 'faq.a2') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('keyword-density', 'faq.q3') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('keyword-density', 'faq.a3') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('keyword-density', 'faq.q4') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('keyword-density', 'faq.a4') }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">{{ __tool('keyword-density', 'faq.q5') }}</h4>
                    <p class="text-gray-700 leading-relaxed">{{ __tool('keyword-density', 'faq.a5') }}</p>
                </div>
            </div>
        </div>
@endsection
