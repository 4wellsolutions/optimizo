...
@section('title', 'Free Google SERP Checker - Check Local & International Rankings')
@section('meta_description', 'Check your Google rankings accurately with our Free SERP Checker. Simulate searches from any location, device, or country (UULE supported). No login required.')
@section('meta_keywords', 'google serp checker, free rank tracker, uule generator, local seo tool, check google rankings, mobile serp preview, international seo checker')
...
@section('content')
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div
            ...
            <!-- Background Patterns (Exact match to Redirect Checker) -->
            ...
            <div class="relative z-10 text-center">
                ...
                <p class="text-base md:text-lg text-white/90 font-medium max-w-3xl mx-auto leading-relaxed">
                    Check live rankings from any location. 100% Free & Privacy Focused.
                </p>
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-purple-200 mb-8">
            <div class="text-center mb-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-2">Live Result Simulation</h2>
            ...
            <form id="serpForm" onsubmit="handleSearch(event)" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="relative">
                        ...
                        <div id="locationDropdown" class="hidden absolute z-50 w-full mt-2 bg-white rounded-xl shadow-2xl border border-gray-100 max-h-60 overflow-y-auto custom-scrollbar ring-1 ring-black/5"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="googleDomain" class="appearance-none w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent font-medium text-gray-700 bg-white pr-10 cursor-pointer hover:border-purple-300 transition-colors">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="deviceType" class="appearance-none w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent font-medium text-gray-700 bg-white pr-10 cursor-pointer hover:border-purple-300 transition-colors">
                ...
                <div class="pt-4">
                    ...
                    <p class="text-center text-xs font-bold text-gray-400 mt-4 uppercase tracking-wider">
                        <span class="text-purple-600">✔</span> No Login Required &nbsp;•&nbsp; <span class="text-purple-600">✔</span> Real-Time Results
                    </p>
                </div>
            </form>
        </div>
        ...
        <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 md:p-12 border-2 border-purple-100 shadow-2xl">
            ...
            <div class="text-center mb-16">
                <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl shadow-xl mb-6">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                    In the world of SEO, <span class="text-purple-600 font-bold">accuracy is everything</span>. Our tool
                    bypasses personalization algorithms to show you the <strong>true rankings</strong> of your website.
                </p>
            </div>

            <!-- Feature Grid -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
                <div class="bg-white p-6 rounded-2xl shadow-lg border-2 border-transparent hover:border-purple-200 transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <h3 class="font-bold text-xl text-gray-900 mb-3">Hyper-Local Accuracy</h3>
                    <p class="text-sm text-gray-600 leading-relaxed">
                        Rank for "pizza in midtown manhattan". We use advanced <strong>Google UULE parameters</strong> 
                        to simulate precise localized searches.
                    </p>
                </div>
                
                <div class="bg-white p-6 rounded-2xl shadow-lg border-2 border-transparent hover:border-blue-200 transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <h3 class="font-bold text-xl text-gray-900 mb-3">Mobile-First Check</h3>
                    <p class="text-sm text-gray-600 leading-relaxed">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg border-2 border-transparent hover:border-green-200 transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        Expanding? Check rankings across 190+ countries. Toggle between <strong>Google.co.uk, Google.de, Google.jp</strong> and more.
                    </p>
                </div>
            </div>
            ...
            <!-- SERP Features -->
            <div class="mb-16">
                <h3 class="text-2xl font-black text-gray-900 mb-8 border-b-2 border-purple-100 pb-4">Understanding Google SERP Features</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white/80 p-6 rounded-xl border border-purple-50 hover:bg-white transition-colors">
                        ...
                        <p class="text-sm text-gray-600">
                            Also known as "answer boxes", these appear about 12% of search queries. Our tool helps you check if you own this prime real estate.
                        </p>
                    </div>
                    <div class="bg-white/80 p-6 rounded-xl border border-purple-50 hover:bg-white transition-colors">
                        <h4 class="font-bold text-lg text-gray-900 mb-2 flex items-center gap-2">
                        ...
                        <p class="text-sm text-gray-600">
                            The map-based list of 3 local businesses. Crucial for brick-and-mortar stores. Use our "Location" feature to verify your presence.
                        </p>
                    </div>
                    <div class="bg-white/80 p-6 rounded-xl border border-purple-50 hover:bg-white transition-colors">
                        <h4 class="font-bold text-lg text-gray-900 mb-2 flex items-center gap-2">
                        ...
                        <p class="text-sm text-gray-600">
                            Accordion-style questions related to the user's query. Ranking here can drive significant awareness traffic.
                        </p>
                    </div>
                    <div class="bg-white/80 p-6 rounded-xl border border-purple-50 hover:bg-white transition-colors">
                        <h4 class="font-bold text-lg text-gray-900 mb-2 flex items-center gap-2">
                        ...
                        <p class="text-sm text-gray-600">
                            Information boxes that appear on the right side of desktop results. Essential for brand authority and entity SEO.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 mb-12 border-l-4 border-purple-500 shadow-sm">
                <h3 class="text-2xl font-bold text-gray-900 mb-6">What is a SERP Checker & Why Need It?</h3>
                <p class="mb-6 text-gray-700 leading-relaxed">
                    A <strong>Search Engine Results Page (SERP) Checker</strong> is an essential diagnostic tool for
                    SEO professionals and business owners. It allows you to view the search results for a specific keyword 
                ...
                <p class="mb-4 text-gray-700">
                    ...
                    and <strong>Device Type</strong>.
                </p>
                <p class="text-gray-700 bg-purple-50 p-4 rounded-lg">
                    Our <strong>Free Google SERP Checker</strong> bursts this bubble. By using the <strong>UULE parameter</strong>, 
                    we generate a specially encoded string that tells Google exactly where to simulate the search from, 
                ...
                <div class="space-y-4 max-w-3xl mx-auto">
                    ...
                    <details class="group bg-white rounded-2xl shadow-sm border border-purple-100 overflow-hidden">
                        <summary class="flex justify-between items-center font-bold text-gray-800 cursor-pointer list-none p-6 hover:bg-gray-50 transition-colors">
                            <span>Is this Google SERP Checker truly free?</span>
                        ...
                        <div class="text-gray-600 p-6 pt-0 leading-relaxed">
                            Yes! Our tool is 100% free to use. You can check as many keywords as you like without creating an account or paying a subscription fee. We believe in providing accessible SEO tools for everyone.
                        </div>
                    </details>
                    ...
                    <details class="group bg-white rounded-2xl shadow-sm border border-purple-100 overflow-hidden">
                        <summary class="flex justify-between items-center font-bold text-gray-800 cursor-pointer list-none p-6 hover:bg-gray-50 transition-colors">
                            <span>How does the Location feature work?</span>
                            <span class="transition-transform duration-300 group-open:rotate-180 text-purple-600">
                                <svg fill="none" height="24" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path></svg>
                            </span>
                        </summary>
                        <div class="text-gray-600 p-6 pt-0 leading-relaxed">
                            We use Google's official <strong>UULE (Universal URL Location Encoded)</strong> parameter. When you enter a city, we find its precise GPS coordinates and encode them into the search request, forcing Google to show results as if you were physically standing in that city.
                        </div>
                    </details>
                    ...
                    <details class="group bg-white rounded-2xl shadow-sm border border-purple-100 overflow-hidden">
                        <summary class="flex justify-between items-center font-bold text-gray-800 cursor-pointer list-none p-6 hover:bg-gray-50 transition-colors">
                            <span>Why do my results look different on Mobile?</span>
                            <span class="transition-transform duration-300 group-open:rotate-180 text-purple-600">
                                <svg fill="none" height="24" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path></svg>
                            </span>
                        </summary>
                        <div class="text-gray-600 p-6 pt-0 leading-relaxed">
                            Google uses <strong>Mobile-First Indexing</strong>, meaning it predominantly uses the mobile version of the content for indexing and ranking. Mobile search results also have different layouts (more ads, different snippets). Use our "Device" selector to verify your mobile presence specifically.
                        </div>
                    </details>
                </div>
            </div>
