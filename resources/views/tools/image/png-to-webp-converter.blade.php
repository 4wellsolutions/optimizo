    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-purple-50 mb-12">
            <div class="text-center mb-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-2">{!! __tool('png-to-webp-converter', 'input.title') !!}</h2>
                <p class="text-gray-600">{!! __tool('png-to-webp-converter', 'input.desc') !!}</p>
            </div>
            ...
            <div id="dropZone"
                ...
                <div class="space-y-4 pointer-events-none">
                    ...
                    <div>
                        <p class="text-lg font-bold text-gray-700">{!! __tool('png-to-webp-converter', 'input.drop_title') !!}</p>
                        <p class="text-sm text-gray-500">{!! __tool('png-to-webp-converter', 'input.drop_desc') !!}</p>
                    </div>
                </div>
            </div>
            ...
            <div id="editorArea" class="hidden mt-8 grid md:grid-cols-2 gap-8">
                ...
                <div class="flex flex-col justify-center space-y-6">
                    <div class="text-center text-gray-600 font-medium">
                        {!! __tool('png-to-webp-converter', 'editor.output_format') !!} <span
                            class="font-bold text-purple-600">WEBP</span>
                    </div>

                    <div class="w-full">
                        <label
                            class="block text-sm font-bold text-gray-700 mb-2">{!! __tool('png-to-webp-converter', 'editor.quality') !!}</label>
        ...
        <div class="mt-12 mb-20 max-w-7xl mx-auto">
            <article
                ...
                <h2 class="text-3xl font-black text-gray-900 mb-6 text-center">
                    {!! __tool('png-to-webp-converter', 'content.title') !!}
                </h2>
                <div class="text-gray-600 text-center mb-12">
                    <p class="mb-4">
                        {!! __tool('png-to-webp-converter', 'content.p1') !!}
                    </p>
                    <p>
                        {!! __tool('png-to-webp-converter', 'content.p2') !!}
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8 mb-16 not-prose">
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 text-center">
                        ...
                        <h3 class="font-bold text-xl mb-2 text-gray-900">
                            {!! __tool('png-to-webp-converter', 'content.features.smaller.title') !!}
                        </h3>
                        <p class="text-sm text-gray-600">{!! __tool('png-to-webp-converter', 'content.features.smaller.desc') !!}</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 text-center">
                        <div
                        ...
                        <h3 class="font-bold text-xl mb-2 text-gray-900">
                            {!! __tool('png-to-webp-converter', 'content.features.transparency.title') !!}
                        </h3>
                        <p class="text-sm text-gray-600">{!! __tool('png-to-webp-converter', 'content.features.transparency.desc') !!}
                        </p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 text-center">
                        <div
                        ...
                        <h3 class="font-bold text-xl mb-2 text-gray-900">
                            {!! __tool('png-to-webp-converter', 'content.features.adjustable.title') !!}
                        </h3>
                        <p class="text-sm text-gray-600">{!! __tool('png-to-webp-converter', 'content.features.adjustable.desc') !!}
                        </p>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-12">
                    <div>
                        <h3 class="font-bold text-2xl mb-4 text-gray-900">
                            {!! __tool('png-to-webp-converter', 'content.how_to.title') !!}</h3>
                        <ol class="list-decimal pl-5 space-y-2 text-gray-600">
                            @foreach(__tool('png-to-webp-converter', 'content.how_to.list') as $step)
                                <li>{!! $step !!}</li>
                            @endforeach
                        </ol>
                    </div>
                    <div>
                        <h3 class="font-bold text-2xl mb-4 text-gray-900">{!! __tool('png-to-webp-converter', 'content.why.title') !!}
                        </h3>
                        <p class="text-gray-600 mb-4">{!! __tool('png-to-webp-converter', 'content.why.p1') !!}</p>
                        <ul class="list-disc pl-5 space-y-2 text-gray-600">
                            @foreach(__tool('png-to-webp-converter', 'content.why.list') as $item)
                                <li>{!! $item !!}</li>
                            @endforeach
                        </ul>
                    </div>
    ...
    @push('scripts')
        <script>
            ...
            function handleFile(file) {
                if (!file.type.match('image.*')) { showError('{!! __tool('png-to-webp-converter', 'js.invalid_image') !!}'); return; }
