    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-indigo-100 mb-12">
            <div class="text-center mb-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-2">{!! __tool('heic-to-jpg-converter', 'input.title') !!}</h2>
                <p class="text-gray-600">{!! __tool('heic-to-jpg-converter', 'input.desc') !!}</p>
            </div>
            ...
            <div id="dropZone"
                ...
                <div class="space-y-4 pointer-events-none">
                    ...
                    <div>
                        <p class="text-lg font-bold text-gray-700">{!! __tool('heic-to-jpg-converter', 'input.drop_title') !!}</p>
                        <p class="text-sm text-gray-500">{!! __tool('heic-to-jpg-converter', 'input.drop_desc') !!}</p>
                    </div>
                </div>
            </div>
            ...
            <div id="loadingIndicator" class="hidden mt-8 text-center">
                ...
                <p class="text-lg font-bold text-gray-700">{!! __tool('heic-to-jpg-converter', 'loading.title') !!}</p>
                <p class="text-sm text-gray-500">{!! __tool('heic-to-jpg-converter', 'loading.desc') !!}</p>
            </div>
            ...
            <div id="editorArea" class="hidden mt-8 grid md:grid-cols-2 gap-8">
                ...
                <div class="flex flex-col justify-center space-y-6">
                    <div class="text-center text-gray-600 font-medium">
                        {!! __tool('heic-to-jpg-converter', 'result.converted_to') !!} <span
        ...
        <div class="mt-12 mb-20 max-w-7xl mx-auto">
            <article
                ...
                <h2 class="text-3xl font-black text-gray-900 mb-6 text-center">
                    {!! __tool('heic-to-jpg-converter', 'content.title') !!}</h2>
                <div class="text-gray-600 text-center mb-12">
                    <p class="mb-4">
                        {!! __tool('heic-to-jpg-converter', 'content.p1') !!}
                    </p>
                    <p>
                        {!! __tool('heic-to-jpg-converter', 'content.p2') !!}
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8 mb-16 not-prose">
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 text-center">
                        ...
                        <h3 class="font-bold text-xl mb-2 text-gray-900">
                            {!! __tool('heic-to-jpg-converter', 'content.features.private.title') !!}</h3>
                        <p class="text-sm text-gray-600">{!! __tool('heic-to-jpg-converter', 'content.features.private.desc') !!}</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 text-center">
                        <div
                        ...
                        <h3 class="font-bold text-xl mb-2 text-gray-900">
                            {!! __tool('heic-to-jpg-converter', 'content.features.compatibility.title') !!}</h3>
                        <p class="text-sm text-gray-600">
                            {!! __tool('heic-to-jpg-converter', 'content.features.compatibility.desc') !!}</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 text-center">
                        <div
                        ...
                        <h3 class="font-bold text-xl mb-2 text-gray-900">
                            {!! __tool('heic-to-jpg-converter', 'content.features.fast.title') !!}</h3>
                        <p class="text-sm text-gray-600">{!! __tool('heic-to-jpg-converter', 'content.features.fast.desc') !!}</p>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-12">
                    <div>
                        <h3 class="font-bold text-2xl mb-4 text-gray-900">
                            {!! __tool('heic-to-jpg-converter', 'content.how_to.title') !!}</h3>
                        <ol class="list-decimal pl-5 space-y-2 text-gray-600">
                            @foreach(__tool('heic-to-jpg-converter', 'content.how_to.list') as $step)
                                <li>{!! $step !!}</li>
                            @endforeach
                        </ol>
                    </div>
                    <div>
                        <h3 class="font-bold text-2xl mb-4 text-gray-900">
                            {!! __tool('heic-to-jpg-converter', 'content.details.title') !!}</h3>
                        <p class="text-gray-600 mb-4">
                            {!! __tool('heic-to-jpg-converter', 'content.details.p1') !!}
                        </p>
                        <p class="text-gray-600">
                            {!! __tool('heic-to-jpg-converter', 'content.details.p2') !!}
                        </p>
                    </div>
                </div>
                ...
                <div>
                    <h3 class="font-bold text-2xl mb-6 text-center text-gray-900">
                        {!! __tool('heic-to-jpg-converter', 'content.faq.title') !!}</h3>
                    <div class="grid md:grid-cols-2 gap-6">
                        <div class="bg-gray-50 rounded-xl p-6">
                            <h4 class="font-bold text-lg mb-2 text-gray-800">{!! __tool('heic-to-jpg-converter', 'content.faq.q1') !!}
                            </h4>
                            <p class="text-gray-600 text-sm">{!! __tool('heic-to-jpg-converter', 'content.faq.a1') !!}</p>
                        </div>
                        <div class="bg-gray-50 rounded-xl p-6">
                            <h4 class="font-bold text-lg mb-2 text-gray-800">{!! __tool('heic-to-jpg-converter', 'content.faq.q2') !!}
                            </h4>
                            <p class="text-gray-600 text-sm">{!! __tool('heic-to-jpg-converter', 'content.faq.a2') !!}</p>
                        </div>
                    </div>
                </div>
            </article>
        ...
        <script>
            ...
            function processHeic(file) {
                ...
                heic2any({
                    ...
                    .catch(function (e) {
                        loadingIndicator.classList.add('hidden');
                        showError('{!! __tool('heic-to-jpg-converter', 'js.error') !!}' + e.message);
                        console.error(e);
                    });
            }
