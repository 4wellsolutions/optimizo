...
@section('title', __tool('json-to-yaml-converter', 'meta.title'))
@section('meta_description', __tool('json-to-yaml-converter', 'meta.description'))
        ...
        <div
            ...
            <div class="relative z-10 text-center">
                ...
                <p class="text-base md:text-lg text-white/90 font-medium max-w-3xl mx-auto">
                    {{ __tool('json-to-yaml-converter', 'content.hero_subtitle') }}
                </p>
        ...
        <div class="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-3xl p-8 md:p-12 border-2 border-cyan-100 shadow-2xl">
            <div class="text-center mb-8">
                ...
                <h2 class="text-4xl font-black text-gray-900 mb-3">
                    {{ __tool('json-to-yaml-converter', 'content.hero_title') }}</h2>
            ...
            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('json-to-yaml-converter', 'content.what_title') }}
            </h3>
            ...
            <h3 class="text-3xl font-bold text-gray-900 mb-6">
                {{ __tool('json-to-yaml-converter', 'content.features_title') }}</h3>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
                <div
                    ...
                    <h4 class="font-bold text-gray-900 mb-2">
                        {{ __tool('json-to-yaml-converter', 'content.features.fast.title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('json-to-yaml-converter', 'content.features.fast.desc') }}
                    </p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-cyan-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">🔒</div>
                    <h4 class="font-bold text-gray-900 mb-2">
                        {{ __tool('json-to-yaml-converter', 'content.features.secure.title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('json-to-yaml-converter', 'content.features.secure.desc') }}
                    </p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-cyan-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">📋</div>
                    <h4 class="font-bold text-gray-900 mb-2">
                        {{ __tool('json-to-yaml-converter', 'content.features.copy.title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('json-to-yaml-converter', 'content.features.copy.desc') }}
                    </p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-cyan-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">🎯</div>
                    <h4 class="font-bold text-gray-900 mb-2">
                        {{ __tool('json-to-yaml-converter', 'content.features.format.title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('json-to-yaml-converter', 'content.features.format.desc') }}
                    </p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-cyan-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">🆓</div>
                    <h4 class="font-bold text-gray-900 mb-2">
                        {{ __tool('json-to-yaml-converter', 'content.features.free.title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('json-to-yaml-converter', 'content.features.free.desc') }}
                    </p>
                </div>
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-cyan-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">🌐</div>
                    <h4 class="font-bold text-gray-900 mb-2">
                        {{ __tool('json-to-yaml-converter', 'content.features.offline.title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('json-to-yaml-converter', 'content.features.offline.desc') }}
                    </p>
                </div>
            </div>

            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('json-to-yaml-converter', 'content.uses_title') }}
            </h3>
            <div class="grid md:grid-cols-2 gap-6 mb-10">
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    <h4 class="font-bold text-lg text-gray-900 mb-3">
                        {{ __tool('json-to-yaml-converter', 'content.uses.docker.title') }}</h4>
                    <p class="text-gray-700 leading-relaxed">
                        {{ __tool('json-to-yaml-converter', 'content.uses.docker.desc') }}</p>
                </div>
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    <h4 class="font-bold text-lg text-gray-900 mb-3">
                        {{ __tool('json-to-yaml-converter', 'content.uses.config.title') }}</h4>
                    <p class="text-gray-700 leading-relaxed">
                        {{ __tool('json-to-yaml-converter', 'content.uses.config.desc') }}</p>
                </div>
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    <h4 class="font-bold text-lg text-gray-900 mb-3">
                        {{ __tool('json-to-yaml-converter', 'content.uses.cicd.title') }}</h4>
                    <p class="text-gray-700 leading-relaxed">
                        {{ __tool('json-to-yaml-converter', 'content.uses.cicd.desc') }}</p>
                </div>
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    <h4 class="font-bold text-lg text-gray-900 mb-3">
                        {{ __tool('json-to-yaml-converter', 'content.uses.cloud.title') }}</h4>
                    <p class="text-gray-700 leading-relaxed">
                        {{ __tool('json-to-yaml-converter', 'content.uses.cloud.desc') }}</p>
                </div>
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    <h4 class="font-bold text-lg text-gray-900 mb-3">
                        {{ __tool('json-to-yaml-converter', 'content.uses.data.title') }}</h4>
                    <p class="text-gray-700 leading-relaxed">
                        {{ __tool('json-to-yaml-converter', 'content.uses.data.desc') }}</p>
                </div>
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    <h4 class="font-bold text-lg text-gray-900 mb-3">
                        {{ __tool('json-to-yaml-converter', 'content.uses.tools.title') }}</h4>
                    <p class="text-gray-700 leading-relaxed">
                        {{ __tool('json-to-yaml-converter', 'content.uses.tools.desc') }}</p>
                </div>
            </div>

            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('json-to-yaml-converter', 'content.how_title') }}
            </h3>
            <div class="bg-white rounded-xl p-6 border-2 border-gray-200 mb-8 shadow-lg">
                <ol class="space-y-4">
                    <li class="flex items-start">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900 mb-1">
                                {{ __tool('json-to-yaml-converter', 'content.how_steps.1.title') }}</p>
                    ...
                    <li class="flex items-start">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900 mb-1">
                                {{ __tool('json-to-yaml-converter', 'content.how_steps.2.title') }}</p>
                    ...
                    <li class="flex items-start">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900 mb-1">
                                {{ __tool('json-to-yaml-converter', 'content.how_steps.3.title') }}</p>
            ...
            <h3 class="text-3xl font-bold text-gray-900 mb-6 font-primary">
                {{ __tool('json-to-yaml-converter', 'content.samples_title') }}</h3>
            <div class="bg-white rounded-xl p-6 border-2 border-gray-200 mb-8 shadow-lg">
                <div class="space-y-6">
                    @php $samples = __tool('json-to-yaml-converter', 'content.samples'); @endphp
                    @if(is_array($samples))
                            ...
                            <div>
                                ...
                                <div class="grid md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <pre
                                            class="bg-gray-50 p-3 rounded text-sm overflow-x-auto"><code>{{ $sample['json'] }}</code></pre>
                                    </div>
                                    <div>
                                        <p class="text-sm font-semibold text-gray-700 mb-2">YAML:</p>
                                        <pre
                                            class="bg-gray-50 p-3 rounded text-sm overflow-x-auto"><code>{{ $sample['yaml'] }}</code></pre>
                                    </div>
                                </div>
                            </div>
                        @endforeach
