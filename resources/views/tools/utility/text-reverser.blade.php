    ...
    <div class="max-w-6xl mx-auto">
        <div
            ...
            <div class="relative z-10 text-center">
                ...
                <h1 class="text-2xl md:text-3xl lg:text-4xl font-black text-white mb-2 leading-tight">Text Reverser</h1>
                <p class="text-base md:text-lg text-white/90 font-medium max-w-3xl mx-auto leading-relaxed">Reverse text
                    character by character instantly - 100% free!</p>
