...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Hero Section -->
        <div
            class="relative overflow-hidden bg-gradient-to-br from-pink-500 via-rose-500 to-red-500 rounded-3xl p-4 md:p-6 mb-8 shadow-2xl">
            ...
            <div class="relative z-10">
                <div class="text-center mb-6">
                    ...
                    <p class="text-base md:text-lg text-white/90 font-medium max-w-3xl mx-auto leading-relaxed">
                        Rasterize your SVG vectors into high-quality PNG images with transparent backgrounds.
                    </p>
                </div>
