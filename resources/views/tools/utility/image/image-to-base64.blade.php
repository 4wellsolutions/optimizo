...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Hero Section -->
        <div
            class="relative overflow-hidden bg-gradient-to-br from-gray-700 via-gray-800 to-black rounded-3xl p-4 md:p-6 mb-8 shadow-2xl">
            ...
            <div class="relative z-10">
                <div class="text-center mb-6">
                    <div class="inline-flex items-center justify-center w-14 h-14 bg-white rounded-2xl shadow-2xl mb-3">
                        <svg class="w-9 h-9 text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-base md:text-lg text-white/90 font-medium max-w-3xl mx-auto leading-relaxed">
                        Transform images into Base64 strings for direct embedding in code. Support for Data URIs.
                    </p>
                </div>
