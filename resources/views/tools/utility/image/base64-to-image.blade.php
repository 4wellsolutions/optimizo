    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-gray-100 mb-12">
            <div class="text-center mb-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-2">{!! __tool('base64-to-image', 'input.title') !!}</h2>
                <p class="text-gray-600">{!! __tool('base64-to-image', 'input.desc') !!}</p>
            </div>

            <!-- Input Area -->
            <div class="mb-6">
                <textarea id="base64Input" placeholder="{!! __tool('base64-to-image', 'input.placeholder') !!}"
            ...
            <button id="convertBtn"
                ...
                {!! __tool('base64-to-image', 'input.btn_decode') !!}
            </button>
            ...
            <div id="resultArea" class="hidden mt-8 grid md:grid-cols-2 gap-8 animate-fade-in">
                ...
                <div class="bg-gray-50 rounded-xl p-4 flex items-center justify-center border border-gray-200 h-[400px]">
                    <img id="imagePreview" class="max-h-full max-w-full object-contain rounded-lg shadow-sm" src=""
                        alt="{!! __tool('base64-to-image', 'result.image_alt') !!}">
                </div>

                <!-- Right Column: Actions -->
                <div class="flex flex-col justify-center space-y-6">
                    <div class="text-center text-gray-600 font-medium">{!! __tool('base64-to-image', 'result.success') !!}
                    </div>
        ...
        <div class="mt-12 mb-20 max-w-7xl mx-auto">
            <article
                ...
                <h2 class="text-3xl font-black text-gray-900 mb-6 text-center">
                    {!! __tool('base64-to-image', 'content.title') !!}
                </h2>
                <div class="text-gray-600 text-center mb-12">
                    <p class="mb-4">
                        {!! __tool('base64-to-image', 'content.p1') !!}
                    </p>
                    <p>
                        {!! __tool('base64-to-image', 'content.p2') !!}
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8 mb-16 not-prose">
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 text-center">
                        ...
                        <h3 class="font-bold text-xl mb-2 text-gray-900">
                            {!! __tool('base64-to-image', 'content.features.preview.title') !!}
                        </h3>
                        <p class="text-sm text-gray-600">{!! __tool('base64-to-image', 'content.features.preview.desc') !!}
                        </p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 text-center">
                        <div
                        ...
                        <h3 class="font-bold text-xl mb-2 text-gray-900">
                            {!! __tool('base64-to-image', 'content.features.auto.title') !!}
                        </h3>
                        <p class="text-sm text-gray-600">{!! __tool('base64-to-image', 'content.features.auto.desc') !!}</p>
                    </div>
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 text-center">
                        <div
                        ...
                        <h3 class="font-bold text-xl mb-2 text-gray-900">
                            {!! __tool('base64-to-image', 'content.features.download.title') !!}
                        </h3>
                        <p class="text-sm text-gray-600">{!! __tool('base64-to-image', 'content.features.download.desc') !!}
                        </p>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-12">
                    <div>
                        <h3 class="font-bold text-2xl mb-4 text-gray-900">
                            {!! __tool('base64-to-image', 'content.how_to.title') !!}
                        </h3>
                        <ol class="list-decimal pl-5 space-y-2 text-gray-600">
                            @foreach(__tool('base64-to-image', 'content.how_to.list') as $step)
                                <li>{!! $step !!}</li>
                            @endforeach
                        </ol>
                    </div>
                    <div>
                        <h3 class="font-bold text-2xl mb-4 text-gray-900">
                            {!! __tool('base64-to-image', 'content.use_cases.title') !!}
                        </h3>
                        <ul class="list-disc pl-5 space-y-2 text-gray-600">
                            @foreach(__tool('base64-to-image', 'content.use_cases.list') as $item)
                                <li>{!! $item !!}</li>
                            @endforeach
                        </ul>
                    </div>
