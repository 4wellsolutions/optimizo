...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Hero Section -->
        <div
            class="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-blue-600 to-sky-600 rounded-3xl p-4 md:p-6 mb-8 shadow-2xl">
            ...
            <div class="relative z-10">
                <div class="text-center mb-6">
                    ...
                    <p class="text-base md:text-lg text-white/90 font-medium max-w-3xl mx-auto leading-relaxed">
                        Easily convert iPhone/iPad HEIC photos to compatible JPG images. No uploads required - processed
                        locally.
                    </p>
                </div>
