...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Hero Section -->
        <div
            class="relative overflow-hidden bg-gradient-to-br from-cyan-500 via-teal-500 to-blue-500 rounded-3xl p-4 md:p-6 mb-8 shadow-2xl">
            ...
            <div class="relative z-10">
                <div class="text-center mb-6">
                    ...
                    <p class="text-base md:text-lg text-white/90 font-medium max-w-3xl mx-auto leading-relaxed">
                        Convert WebP graphics to the widely supported JPG format. Ensure your images open on any device.
                    </p>
                </div>
    ...
    <script>
        ...
        function handleFile(file) {
            if (!file.type.match('image.*')) { alert('Please upload a valid WEBP image'); return; }
