        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-green-200 mb-8">
            <div class="flex gap-2 mb-6 border-b-2 border-gray-200">
                ...
                <button onclick="switchTab('decode')" id="decodeTab"
                    class="tab-btn px-6 py-3 font-bold text-lg">
                    Decode from Base64
                </button>
            </div>
                ...
                <div id="encodePanel">
                    <div class="mb-6">
                        ...
                        <textarea id="encodeInput" rows="8" class="form-input font-mono text-sm"
                ...
                <div id="decodePanel" class="hidden">
                    <div class="mb-6">
                        ...
                        <textarea id="decodeInput" rows="8" class="form-input font-mono text-sm"
