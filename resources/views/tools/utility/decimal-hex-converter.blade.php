    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div
            ...
            <div class="relative z-10 text-center">
                ...
                <p class="text-base md:text-lg text-white/90 font-medium max-w-3xl mx-auto leading-relaxed">
                    Convert decimal numbers to hexadecimal and vice versa - 100% free, instant, and accurate!
                </p>
        ...
        <div
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-4xl font-black text-gray-900 mb-3">Free Decimal ↔ Hexadecimal Converter</h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Convert between decimal and hexadecimal number systems
                </p>
            </div>
