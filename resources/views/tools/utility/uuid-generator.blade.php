...
@section('content')
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-blue-200 mb-8">
            <div class="mb-6 flex items-center gap-4">
                ...
                <div class="flex-1">
                    <label for="version" class="block text-sm font-semibold text-gray-700 mb-2">Version</label>
            ...
            <div class="mb-4">
                <label for="outputText" class="block text-sm font-semibold text-gray-700 mb-2">Generated UUIDs</label>
        ...
        <div class="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 md:p-12 border-2 border-blue-100 shadow-2xl">
            <h2 class="text-3xl font-black text-gray-900 mb-4 text-center">About UUIDs (Version 4)</h2>
            <p class="text-gray-700 text-center max-w-2xl mx-auto leading-relaxed">
                ...
                Version 4 UUIDs are generated using random or pseudo-random numbers. The probability of duplication is
                virtually zero.
            </p>
        </div>
    </div>
    ...
    <script>
        function generateUUIDs() {
            ...
            showStatus('Generated ' + count + ' UUIDs!', 'success');
        }
