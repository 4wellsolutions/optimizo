    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-purple-200 mb-8">
            <div class="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label for="min" class="block text-sm font-semibold text-gray-700 mb-2">Min Value</label>
                ...
                <div>
                    <label for="max" class="block text-sm font-semibold text-gray-700 mb-2">Max Value</label>
            ...
            <div class="mb-6">
                <label for="count" class="block text-sm font-semibold text-gray-700 mb-2">Quantity</label>
            ...
            <div class="mb-4">
                <label for="outputResult" class="block text-sm font-semibold text-gray-700 mb-2">Result</label>
                <div id="outputResult"
        ...
        <div
            ...
            <h2 class="text-3xl font-black text-gray-900 mb-3 text-center">Random Number Generation</h2>
            <p class="text-gray-600 text-center mx-auto max-w-xl">Generate true random integers within your specified range.
                Useful for games, lotteries, statistical sampling, and giveaways.</p>
        </div>
    </div>
