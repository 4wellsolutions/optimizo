...
@section('content')
    <div class="max-w-6xl mx-auto">
        <div class="relative overflow-hidden bg-gradient-to-br from-orange-500 via-red-500 to-pink-600 rounded-3xl p-4 md:p-6 mb-8 shadow-2xl">
            <div class="absolute top-0 right-0 w-64 h-64 bg-white opacity-10 rounded-full -mr-32 -mt-32"></div>
            <div class="relative z-10 text-center">
                <div class="inline-flex items-center justify-center w-14 h-14 bg-white rounded-2xl shadow-2xl mb-3">
                    <svg class="w-9 h-9 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" /></svg>
                </div>
                <h1 class="text-2xl md:text-3xl lg:text-4xl font-black text-white mb-2">XML to CSV Converter</h1>
                <p class="text-base md:text-lg text-white/90 font-medium max-w-3xl mx-auto">Convert XML data to CSV format instantly!</p>
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-orange-200 mb-8">
            <div class="flex flex-wrap gap-3 mb-6">
                <button onclick="convert()" class="btn-primary"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg><span>Convert to CSV</span></button>
            ...
            <div class="grid md:grid-cols-2 gap-6"><div><label for="xmlInput" class="form-label text-base">Enter XML</label><textarea id="xmlInput" class="form-input font-mono text-sm min-h-[400px]" placeholder="<data><row><name>John</name><age>30</age></row></data>"></textarea></div><div><label for="csvOutput" class="form-label text-base">CSV Output</label><textarea id="csvOutput" class="form-input font-mono text-sm min-h-[400px]" readonly placeholder="Converted CSV will appear here..."></textarea></div></div>
        </div>
        ...
        <div class="bg-gradient-to-br from-orange-50 to-red-50 rounded-3xl p-8 md:p-12 border-2 border-orange-100 shadow-2xl">
            <div class="text-center mb-8">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Transform XML data into spreadsheet-friendly CSV format</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-10">
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    ...
                    <p class="text-gray-700 leading-relaxed">Convert XML reports and data exports to CSV for analysis in Excel, Google Sheets, or BI tools.</p>
                </div>
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    <h4 class="font-bold text-lg text-gray-900 mb-3">🔄 System Migration</h4>
                    <p class="text-gray-700 leading-relaxed">Transform XML data from legacy systems to CSV for import into modern databases and applications.</p>
                </div>
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    <h4 class="font-bold text-lg text-gray-900 mb-3">📈 Reporting</h4>
                    <p class="text-gray-700 leading-relaxed">Convert XML API responses to CSV for creating reports and dashboards.</p>
                </div>
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    <h4 class="font-bold text-lg text-gray-900 mb-3">🗄️ Database Import</h4>
                    <p class="text-gray-700 leading-relaxed">Transform XML exports to CSV for bulk import into SQL databases.</p>
                </div>
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    <h4 class="font-bold text-lg text-gray-900 mb-3">📧 Email Lists</h4>
                    <p class="text-gray-700 leading-relaxed">Convert XML contact data to CSV for email marketing platforms.</p>
                </div>
                <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                    <h4 class="font-bold text-lg text-gray-900 mb-3">🔍 Data Cleaning</h4>
                    <p class="text-gray-700 leading-relaxed">Transform XML to CSV for easier data cleaning and manipulation in spreadsheets.</p>
                </div>
            </div>
                ...
                <ol class="space-y-4">
                    <li class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Copy XML data from your source and paste it into the left input field.</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                    ...
                    <li class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">The CSV output appears on the right. Click "Copy" to paste it into Excel or any application.</p>
                        </div>
                    </li>
                </ol>
            </div>
...
John,30</code></pre>
            ...
            <div class="space-y-4 mb-8">
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    ...
                    <p class="text-gray-700 leading-relaxed">The converter expects XML with &lt;row&gt; elements. Each row's child elements become CSV columns. The first row determines the column headers.</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">Is my data secure?</h4>
                    <p class="text-gray-700 leading-relaxed">Yes! All conversion happens in your browser using JavaScript. Your XML data never leaves your device or gets sent to any server.</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">Can I import the CSV into Excel?</h4>
                    <p class="text-gray-700 leading-relaxed">Absolutely! The generated CSV works perfectly with Excel, Google Sheets, and all spreadsheet applications. Just copy and paste or save as a .csv file.</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">What if my XML has nested elements?</h4>
                    <p class="text-gray-700 leading-relaxed">The converter works best with flat XML structures. Nested elements will be flattened. For complex nested XML, consider restructuring before conversion.</p>
                </div>
                <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                    <h4 class="font-bold text-gray-900 mb-3 text-lg">Can I convert large XML files?</h4>
                    <p class="text-gray-700 leading-relaxed">Yes, you can convert XML files of any size. Very large files may take a few seconds to process depending on your device's performance.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-lg">
                <ul class="space-y-3">
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-700"><strong>Use row elements:</strong> Structure your XML with &lt;row&gt; elements for best results.</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        <span class="text-gray-700"><strong>Consistent structure:</strong> Ensure all rows have the same child elements for proper CSV columns.</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        <span class="text-gray-700"><strong>Test with examples:</strong> Use the "Example" button to understand the expected XML format.</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        <span class="text-gray-700"><strong>Validate XML first:</strong> Ensure your XML is well-formed before conversion.</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        <span class="text-gray-700"><strong>Handle special characters:</strong> Commas in data are automatically handled in the CSV output.</span>
                    </li>
                </ul>
            </div>
        </div>
