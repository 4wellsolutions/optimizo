    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-amber-200 mb-8">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    <label for="tsvInput" class="form-label text-base">{{ __tool('tsv-to-csv', 'editor.label_input') }}</label>
                ...
                <div>
                    <label for="csvOutput" class="form-label text-base">{{ __tool('tsv-to-csv', 'editor.label_output') }}</label>
        ...
        <!-- SEO Content -->
        <div class="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-3xl p-8 md:p-12 border-2 border-amber-100 shadow-2xl">
            <div class="text-center mb-8">
                <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-amber-500 to-yellow-600 rounded-2xl shadow-xl mb-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
                ...
                <div class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-amber-300 transition-all shadow-lg hover:shadow-xl">
            ...
            <div class="bg-white rounded-xl p-6 border-2 border-gray-200 mb-8 shadow-lg">
                <ol class="space-y-4">
                    ...
                    <li class="flex items-start">
                        <span class="flex-shrink-0 w-8 h-8 bg-amber-600 text-white rounded-full flex items-center justify-center font-bold mr-3">{{ $loop->iteration }}</span>
                        <div>
            ...
            <div class="bg-white rounded-xl p-6 border-2 border-gray-200 mb-8 shadow-lg">
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                        <p class="text-sm font-semibold text-gray-700 mb-2">{{ __tool('tsv-to-csv', 'content.examples.input') }}</p>
                        <pre class="bg-gray-50 p-3 rounded text-sm overflow-x-auto"><code>name	age	city
    John	30	New York</code></pre>
                    </div>
                    <div>
                        <p class="text-sm font-semibold text-gray-700 mb-2">{{ __tool('tsv-to-csv', 'content.examples.output') }}</p>
                        <pre class="bg-gray-50 p-3 rounded text-sm overflow-x-auto"><code>name,age,city
    John,30,New York</code></pre>
                    </div>
                </div>
                ...
                @foreach(__tool('tsv-to-csv', 'content.faq') as $key => $value)
                    @if(str_starts_with($key, 'q'))
                        <div class="bg-white rounded-2xl p-6 border-2 border-gray-200 shadow-lg hover:shadow-xl transition-all">
                            ...
                            <p class="text-gray-700 leading-relaxed">{{ __tool('tsv-to-csv', 'content.faq.' . str_replace('q', 'a', $key)) }}</p>
                        </div>
                    @endif
                @endforeach
            </div>
