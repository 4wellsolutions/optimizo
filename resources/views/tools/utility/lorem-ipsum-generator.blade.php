    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-indigo-200 mb-8">
            <div class="grid md:grid-cols-3 gap-6 mb-6">
                <div>
                    <label for="count" class="block text-sm font-semibold text-gray-700 mb-2">Count</label>
                ...
                <div class="flex items-end pb-3">
                    <label class="inline-flex items-center text-gray-700 font-semibold cursor-pointer">
                        ...
                        <span class="ml-2">Start with "Lorem ipsum..."</span>
                    </label>
                </div>
            </div>
            ...
            <div class="mb-4">
                <label for="outputText" class="block text-sm font-semibold text-gray-700 mb-2">Generated Text</label>
        ...
        <div
            ...
            <div class="text-center mb-8">
                <h2 class="text-3xl font-black text-gray-900 mb-3">About Lorem Ipsum Generator</h2>
                <p class="text-gray-600 max-w-2xl mx-auto">Generate placeholder text for your designs, mockups, and layout
                    testing.</p>
            </div>
