...
@section('content')
    <div class="max-w-6xl mx-auto">
        <!-- Hero Section -->
        <div class="relative overflow-hidden bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-600 rounded-3xl p-4 md:p-6 mb-8 shadow-2xl">
            ...
            <div class="relative z-10 text-center">
                ...
                <p class="text-base md:text-lg text-white/90 font-medium max-w-3xl mx-auto leading-relaxed">
                    Convert JSON data to XML format instantly - 100% free and easy to use!
                </p>
