...
@section('title', __tool('sentence-case-converter', 'meta.title'))
@section('meta_description', __tool('sentence-case-converter', 'meta.description'))
        ...
        <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 md:p-12 border-2 border-purple-100 shadow-2xl">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
                ...
                <div
                    class="bg-white rounded-xl p-5 border-2 border-gray-200 hover:border-purple-300 transition-all shadow-lg hover:shadow-xl">
                    <div class="text-3xl mb-3">🔒</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('sentence-case-converter', 'content.features.privacy.title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('sentence-case-converter', 'content.features.privacy.desc') }}</p>
                </div>
                <div
                ...
                <div
                    ...
                    <div class="text-3xl mb-3">🎨</div>
                    <h4 class="font-bold text-gray-900 mb-2">{{ __tool('sentence-case-converter', 'content.features.clean.title') }}</h4>
                    <p class="text-gray-600 text-sm">{{ __tool('sentence-case-converter', 'content.features.clean.desc') }}</p>
                </div>
                <div
            ...
            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('sentence-case-converter', 'content.uses_title') }}</h3>
            ...
            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('sentence-case-converter', 'content.how_to_title') }}</h3>
            ...
            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('sentence-case-converter', 'content.examples_title') }}</h3>
            ...
            <h3 class="text-3xl font-bold text-gray-900 mb-6">{{ __tool('sentence-case-converter', 'content.faq_title') }}</h3>
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl border-2 border-gray-100 shadow-sm">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">{{ __tool('sentence-case-converter', 'content.faq.' . str_replace('q', 'a', $faq)) }}</p>
                </div>
                @endforeach
            </div>
        </div>
