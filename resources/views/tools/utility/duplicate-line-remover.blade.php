...
@section('content')
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-orange-200 mb-8">
            <div class="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label for="inputText" class="block text-sm font-semibold text-gray-700 mb-2">Input List</label>
    ...
    Cherry
    Banana"></textarea>
                    <div class="text-right text-xs text-gray-500 mt-1">Lines: <span id="inputCount">0</span></div>
                </div>
                <div>
                    <label for="outputText" class="block text-sm font-semibold text-gray-700 mb-2">Cleaned List
                        (Unique)</label>
                    ...
                    <div class="text-right text-xs text-gray-500 mt-1">Lines: <span id="outputCount">0</span></div>
                </div>
            </div>
    ...
    <script>
        ...
        function removeDuplicates() {
            ...
            showStatus('Removed ' + removed + ' duplicate lines!', 'success');
        }
