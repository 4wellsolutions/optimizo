...
@section('content')
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-indigo-200 mb-8">
            ...
            <div class="mb-6">
                ...
                <div id="panel-headers" class="py-4">
                    <div id="headersList" class="space-y-3">
                        <div class="flex gap-2">
                            <input type="text" placeholder="Key (e.g. Authorization)"
                                class="header-key flex-1 px-3 py-2 border rounded-lg">
                            <input type="text" placeholder="Value (e.g. Bearer token)"
                ...
                <div id="panel-body" class="py-4 hidden">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Raw Data (JSON/Text)</label>
            ...
            <div class="bg-gray-900 rounded-xl p-4 md:p-6 mb-6">
                <div class="flex justify-between items-center mb-2">
                    <label class="text-xs font-bold text-gray-400 uppercase tracking-wider">Generated Command</label>
    ...
    <script>
        ...
        function addHeaderRow() {
            ...
            div.innerHTML = '<input type="text" placeholder="Key" class="header-key flex-1 px-3 py-2 border rounded-lg" oninput="updateCurl()"> <input type="text" placeholder="Value" class="header-val flex-1 px-3 py-2 border rounded-lg" oninput="updateCurl()">';
