...
@section('title', __tool('ppt-to-pdf', 'meta.title'))
@section('meta_description', __tool('ppt-to-pdf', 'meta.description'))
    ...
    <div class="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 mb-12">
        <article class="prose prose-lg md:prose-xl max-w-none text-gray-600">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-3xl md:text-4xl font-black text-gray-900 mb-6">{{ __tool('ppt-to-pdf', 'content.main_title') }}</h2>
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16 not-prose">
                <div class="bg-gray-50/50 p-8 rounded-3xl border border-gray-100 hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="font-bold text-2xl text-gray-900 mb-3">{{ __tool('ppt-to-pdf', 'content.feature1_title') }}</h3>
                    <p class="text-base text-gray-600 leading-relaxed">{{ __tool('ppt-to-pdf', 'content.feature1_desc') }}</p>
                </div>
                <div class="bg-gray-50/50 p-8 rounded-3xl border border-gray-100 hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="font-bold text-2xl text-gray-900 mb-3">{{ __tool('ppt-to-pdf', 'content.feature2_title') }}</h3>
                    <p class="text-base text-gray-600 leading-relaxed">{{ __tool('ppt-to-pdf', 'content.feature2_desc') }}</p>
                </div>
                <div class="bg-gray-50/50 p-8 rounded-3xl border border-gray-100 hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="font-bold text-2xl text-gray-900 mb-3">{{ __tool('ppt-to-pdf', 'content.feature3_title') }}</h3>
                    <p class="text-base text-gray-600 leading-relaxed">{{ __tool('ppt-to-pdf', 'content.feature3_desc') }}</p>
                </div>
            </div>

            <div class="max-w-4xl mx-auto space-y-12">
                <div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">{{ __tool('ppt-to-pdf', 'content.how_to_title') }}</h3>
                    <ol class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <div>
                                <strong class="text-gray-900 text-lg">{{ __tool('ppt-to-pdf', 'content.step1_title') }}</strong>
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <strong class="text-gray-900 text-lg">{{ __tool('ppt-to-pdf', 'content.step2_title') }}</strong>
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <strong class="text-gray-900 text-lg">{{ __tool('ppt-to-pdf', 'content.step3_title') }}</strong>
