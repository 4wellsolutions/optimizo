...
@section('title', __tool('excel-to-pdf', 'seo.title', $tool->meta_title))
@section('meta_description', __tool('excel-to-pdf', 'seo.description', $tool->meta_description))
...
@section('content')
    ...
    <div class="bg-white rounded-3xl p-8 md:p-10 shadow-xl border border-gray-100 mb-16">
        <div class="text-center mb-8">
            <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2">{{ __tool('excel-to-pdf', 'form.upload_title') }}
            </h2>
        ...
        <form id="converterForm" action="{{ route('utility.excel-to-pdf.process') }}" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="border-4 border-dashed border-green-100 rounded-3xl p-10 text-center hover:border-green-300 hover:bg-green-50 transition-all cursor-pointer relative group bg-gray-50/50"
                ...
                <div class="space-y-6 pointer-events-none">
                    ...
                    <div>
                        <p class="text-xl font-bold text-gray-700">{{ __tool('excel-to-pdf', 'form.upload_text') }}</p>
                        <p class="text-base text-gray-500 mt-2">{{ __tool('excel-to-pdf', 'form.file_size_limit') }}</p>
                    </div>
                </div>
            ...
            <div class="text-center">
                <button type="submit"
                    ...
                    {{ __tool('excel-to-pdf', 'form.button') }}
                    <!-- Icon: Arrow Right -->
                ...
                <p class="mt-4 text-sm text-gray-400">{{ __tool('excel-to-pdf', 'form.dev_notice') }}</p>
            </div>
        </form>
    </div>
        ...
        <article class="prose prose-lg md:prose-xl max-w-none text-gray-600">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-3xl md:text-4xl font-black text-gray-900 mb-6">
                    {{ __tool('excel-to-pdf', 'content.main_title') }}
                </h2>
                <p class="text-xl leading-relaxed text-gray-600">
                    {{ __tool('excel-to-pdf', 'content.main_desc') }}
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16 not-prose">
                <div class="bg-gray-50/50 p-8 rounded-3xl border border-gray-100 hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="font-bold text-2xl text-gray-900 mb-3">{{ __tool('excel-to-pdf', 'content.feature1_title') }}
                    </h3>
                    <p class="text-base text-gray-600 leading-relaxed">{{ __tool('excel-to-pdf', 'content.feature1_desc') }}
                    </p>
                </div>
                <div class="bg-gray-50/50 p-8 rounded-3xl border border-gray-100 hover:shadow-lg transition-shadow">
                    <div
                    ...
                    <h3 class="font-bold text-2xl text-gray-900 mb-3">{{ __tool('excel-to-pdf', 'content.feature2_title') }}
                    </h3>
                    <p class="text-base text-gray-600 leading-relaxed">{{ __tool('excel-to-pdf', 'content.feature2_desc') }}
                    </p>
                </div>
                <div class="bg-gray-50/50 p-8 rounded-3xl border border-gray-100 hover:shadow-lg transition-shadow">
                    ...
                    <h3 class="font-bold text-2xl text-gray-900 mb-3">{{ __tool('excel-to-pdf', 'content.feature3_title') }}
                    </h3>
                    <p class="text-base text-gray-600 leading-relaxed">{{ __tool('excel-to-pdf', 'content.feature3_desc') }}
                    </p>
                </div>
            </div>
            ...
            <div class="max-w-4xl mx-auto space-y-12">
                <div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">{{ __tool('excel-to-pdf', 'content.how_to_title') }}
                    </h3>
                    <ol class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <div>
                                <strong
                                    class="text-gray-900 text-lg">{{ __tool('excel-to-pdf', 'content.step1_title') }}</strong>
                                <p class="mt-1 text-gray-600">{{ __tool('excel-to-pdf', 'content.step1_desc') }}</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <span
                            ...
                            <div>
                                <strong
                                    class="text-gray-900 text-lg">{{ __tool('excel-to-pdf', 'content.step2_title') }}</strong>
                                <p class="mt-1 text-gray-600">{{ __tool('excel-to-pdf', 'content.step2_desc') }}</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <span
                            ...
                            <div>
                                <strong
                                    class="text-gray-900 text-lg">{{ __tool('excel-to-pdf', 'content.step3_title') }}</strong>
                                <p class="mt-1 text-gray-600">{{ __tool('excel-to-pdf', 'content.step3_desc') }}</p>
                            </div>
                        </li>
                    </ol>
                </div>
