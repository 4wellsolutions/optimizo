...
@section('title', __tool('pdf-to-word', 'seo.title', $tool->meta_title))
@section('meta_description', __tool('pdf-to-word', 'seo.description', $tool->meta_description))
...
@section('content')
    ...
    <div class="bg-white rounded-3xl p-8 md:p-10 shadow-xl border border-gray-100 mb-16">
        ...
        <form id="converterForm" action="{{ route('utility.pdf-to-word.process') }}" enctype="multipart/form-data" class="space-y-8">
            @csrf
