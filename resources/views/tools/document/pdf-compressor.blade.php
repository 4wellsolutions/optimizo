...
@section('title', __tool('pdf-compressor', 'seo.title', $tool->meta_title))
@section('meta_description', __tool('pdf-compressor', 'seo.description', $tool->meta_description))
...
@section('content')
    ...
    <div class="bg-white rounded-3xl p-8 md:p-10 shadow-xl border border-gray-100 mb-16">
        ...
        <form id="converterForm" action="{{ route('utility.pdf-compressor.process') }}" enctype="multipart/form-data" class="space-y-8">
            @csrf
