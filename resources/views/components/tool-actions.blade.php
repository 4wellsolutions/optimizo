...
<div class="flex items-center gap-3 mb-4">
    ...
    <div class="flex gap-2">
        ...
        <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode($tool->meta_title ?? 'Check out this tool') }}"
            target="_blank"
            class="inline-flex items-center justify-center w-10 h-10 bg-blue-400 hover:bg-blue-500 text-white rounded-lg transition-colors duration-200"
        ...
        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}" target="_blank"
            class="inline-flex items-center justify-center w-10 h-10 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-200"
        ...
        <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(url()->current()) }}" target="_blank"
            class="inline-flex items-center justify-center w-10 h-10 bg-blue-700 hover:bg-blue-800 text-white rounded-lg transition-colors duration-200"
        ...
        <a href="https://wa.me/?text={{ urlencode($tool->meta_title . ' - ' . url()->current()) }}" target="_blank"
            class="inline-flex items-center justify-center w-10 h-10 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors duration-200"
    ...
    <button onclick="openReportModal()"
        class="ml-auto inline-flex items-center gap-2 px-4 py-2 bg-red-500 hover:bg-red-600 text-white text-sm font-medium rounded-lg transition-colors duration-200"
...
<div id="reportModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative">
        ...
        <form id="reportForm" onsubmit="submitReport(event)">
            ...
            <!-- Suggestion Text Area (Hidden by default) -->
...
<script>
    ...
    // Show/hide suggestion textarea based on selection
