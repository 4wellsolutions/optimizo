...
return [
    ...
    'css-minifier' => [
        ...
        'content' => [
            ...
            'how_steps' => [
                '<strong>Paste CSS:</strong> Copy and paste your CSS code into the input field',
                '<strong>Choose Action:</strong> Click "Minify CSS" to compress or "Beautify CSS" to format',
                '<strong>View Results:</strong> See the processed CSS in the output field with compression stats',
                '<strong>Copy:</strong> Click "Copy" to copy the minified CSS to your clipboard',
                '<strong>Use in Production:</strong> Replace your original CSS file with the minified version',
            ],
            'best_practices_title' => '💡 Best Practices',
            'best_practices_list' => [
                '<strong>Keep source files:</strong> Always maintain readable, unminified versions for development',
                '<strong>Minify for production:</strong> Only use minified CSS in production environments',
                '<strong>Combine files:</strong> Merge multiple CSS files before minifying for better compression',
                '<strong>Test thoroughly:</strong> Always test minified CSS to ensure no functionality is broken',
                '<strong>Use build tools:</strong> Integrate minification into your build process for automation',
            ],
            'faq_title' => '❓ Frequently Asked Questions',
            'faq' => [
    ...
    'html-encoder-decoder' => [
        ...
        'content' => [
            ...
            'how_steps' => [
                'Choose "Encode HTML" or "Decode HTML" based on your need',
                'Paste your HTML or text in the input field',
    ...
    'html-to-markdown-converter' => [
        ...
        'content' => [
            ...
            'features_title' => '✨ Key Features',
            'features_list' => [
                '✅ <strong>Instant Conversion:</strong> Convert HTML to Markdown in real-time',
                '✅ <strong>Preserve Formatting:</strong> Maintains headings, lists, links, and emphasis',
                '✅ <strong>Clean Output:</strong> Generates readable, well-formatted Markdown',
                '✅ <strong>No Installation:</strong> Works directly in your browser',
                '✅ <strong>Free Forever:</strong> 100% free with no limitations',
                '✅ <strong>Privacy First:</strong> All conversion happens locally in your browser',
            ],
            ...
            'elements_title' => '🛠️ Supported HTML Elements',
            'elements' => [
                'text' => [
    ...
    'json-parser' => [
        ...
        'content' => [
            ...
            'how_title' => '📚 How to Use',
            'how_steps' => [
                '<strong>Paste JSON:</strong> Copy and paste your JSON data into the input field',
                '<strong>Parse:</strong> Click "Parse JSON" to validate and visualize the structure',
                '<strong>Beautify:</strong> Click "Beautify" to format with proper indentation',
                '<strong>Minify:</strong> Click "Minify" to compress and remove whitespace',
                '<strong>View Tree:</strong> See the hierarchical structure in tree view format',
            ],
            'tips_title' => '💡 JSON Best Practices',
            'tips_list' => [
                '<strong>Use double quotes:</strong> JSON requires double quotes for strings, not single quotes',
                '<strong>No trailing commas:</strong> Remove commas after the last item in objects and arrays',
                '<strong>Proper data types:</strong> Use numbers without quotes, booleans as true/false, null for empty values',
                '<strong>Validate regularly:</strong> Always validate JSON before deployment or production use',
                '<strong>Beautify for readability:</strong> Format JSON for easier debugging and maintenance',
            ],
            'faq_title' => '❓ Frequently Asked Questions',
            'faq' => [
    ...
    'json-to-csv-converter' => [
        'meta' => [
            ...
            'description' => 'Free online json to csv converter tool. Fast, secure and easy to use.',
            'h1' => 'JSON to CSV Converter',
            'subtitle' => 'The best json to csv converter for developers and IT professionals',
        ],
        'content' => [
            'what_is_title' => 'What is JSON to CSV Converter?',
            'what_is_desc' => 'This is a free online tool to json to csv converter.',
        ],
    ],
    ...
    'json-to-xml-converter' => [
        'meta' => [
            ...
            'description' => 'Free online json to xml converter tool. Fast, secure and easy to use.',
            'h1' => 'JSON to XML Converter',
            'subtitle' => 'The best json to xml converter for developers and IT professionals',
        ],
        'content' => [
            'what_is_title' => 'What is JSON to XML Converter?',
            'what_is_desc' => 'This is a free online tool to json to xml converter.',
        ],
    ],
    'json-to-yaml-converter' => [
        'meta' => [
            'title' => 'JSON to YAML Converter - Free Online Tool',
            'description' => 'Convert JSON to YAML format instantly with our free online JSON to YAML converter. Fast, secure and easy to use.',
            'h1' => 'JSON to YAML Converter',
            'subtitle' => 'The best json to yaml converter for developers and IT professionals',
        ],
        'editor' => [
            'label_input' => 'JSON Input',
        ...
        'js' => [
            'error_empty' => 'Please enter some JSON text',
            'success_convert' => 'JSON converted to YAML successfully!',
            'error_convert' => 'Error converting JSON: ',
            'error_no_copy' => 'No YAML to copy. Please convert JSON first.',
            'success_copy' => 'YAML copied to clipboard!',
        ],
        'content' => [
            'hero_title' => 'JSON to YAML Converter',
            'hero_subtitle' => 'Convert JSON to YAML format instantly and accurately',
            'p1' => 'Our free JSON to YAML converter allows you to transform JSON data into YAML format instantly. Perfect for developers, DevOps engineers, and anyone working with configuration files or data serialization.',
            'what_title' => 'What is JSON to YAML Converter?',
            'what_desc' => 'JSON (JavaScript Object Notation) and YAML (YAML Ain\'t Markup Language) are both popular data serialization formats. YAML is often preferred for configuration files due to its human-readable syntax. Our tool helps you bridge the gap between these formats quickly.',
            'features_title' => 'Key Features',
            'features' => [
                'fast' => [
                    'title' => 'Fast Conversion',
                    'desc' => 'Convert JSON to YAML in milliseconds',
                ],
                'secure' => [
                    'title' => 'Secure & Private',
                    'desc' => 'Processing happens entirely in your browser',
                ],
                'copy' => [
                    'title' => 'One-Click Copy',
                    'desc' => 'Copy the converted YAML instantly',
                ],
                'format' => [
                    'title' => 'Clean Formatting',
                    'desc' => 'Produces well-indented YAML output',
                ],
                'free' => [
                    'title' => '100% Free',
                ...
                'offline' => [
                    'title' => 'Client-Side',
                    'desc' => 'Works without sending data to a server',
                ],
            ],
            'uses_title' => 'Common Use Cases',
            'uses' => [
                'docker' => [
                    'title' => 'Docker',
                    'desc' => 'Convert JSON container configs to Docker Compose YAML.',
                ],
                'config' => [
                    'title' => 'Config Files',
                    'desc' => 'Transform JSON settings to YAML configuration files.',
                ],
                'cicd' => [
                    'title' => 'CI/CD Pipelines',
                    'desc' => 'Prepare YAML pipeline definitions from JSON data.',
                ],
                'cloud' => [
                    'title' => 'Cloud Provider Configs',
                    'desc' => 'Convert JSON data to YAML format for cloud platforms.',
                ],
                'data' => [
                    'title' => 'Data Transformation',
                    'desc' => 'Switch between JSON and YAML for different data tools.',
                ],
                'tools' => [
                    'title' => 'DevOps Tools',
                    'desc' => 'Format data correctly for tools that expect YAML.',
                ],
            ],
            'how_title' => 'How to Use',
            'how_steps' => [
                1 => ['title' => 'Paste JSON', 'desc' => 'Enter your JSON data into the input field.'],
                2 => ['title' => 'Convert', 'desc' => 'Click the "Convert" button to generate YAML.'],
                3 => ['title' => 'Copy YAML', 'desc' => 'Copy the resulting YAML for your project.'],
            ],
            'samples_title' => 'Conversion Samples',
            'samples' => [
                ['title' => 'Basic Object', 'json' => '{ "name": "Antigravity", "version": "1.0" }', 'yaml' => "name: Antigravity\nversion: 1.0"],
                ['title' => 'Array Example', 'json' => '[ "Java", "Python", "Go" ]', 'yaml' => "- Java\n- Python\n- Go"],
            ],
            'faq_title' => 'Frequently Asked Questions',
            'faq' => [
                'q1' => 'Is it free?',
                'a1' => 'Yes, our JSON to YAML converter is 100% free.',
                'q2' => 'Is it secure?',
                'a2' => 'Yes, all processing happens locally in your browser.',
                'q3' => 'Does it support arrays?',
                'a3' => 'Yes, it handles complex JSON structures including arrays and nested objects.',
                'q4' => 'Is YAML better than JSON?',
                'a4' => 'YAML is often easier for humans to read and write, while JSON is generally better for machine processing.',
                'q5' => 'Can I use this offline?',
                'a5' => 'Yes, once loaded, the tool works offline as it uses local JavaScript.',
            ],
            'tips_title' => 'Pro Tips',
            'tips_list' => [
                1 => 'Ensure your JSON is valid before converting.',
                2 => 'Use the "Example" button to see how the conversion works.',
                3 => 'YAML is case-sensitive, just like JSON.',
                4 => 'Check indentation in the resulting YAML.',
                5 => 'Clear all data easily for a fresh start.',
            ],
        ],
    ],
    'jwt-decoder' => [
...
[Visit our website](https://example.com)',
    ...
    'sql-to-json' => [
        'meta' => [
            'title' => 'SQL to JSON Converter - Free Online Tool',
            'description' => 'Free online sql to json converter tool. Fast, secure and easy to use.',
            'h1' => 'SQL to JSON Converter',
            'subtitle' => 'The best sql to json converter for developers and IT professionals',
        ],
        'content' => [
            'what_is_title' => 'What is SQL to JSON Converter?',
            'what_is_desc' => 'This is a free online tool to sql to json converter.',
        ],
    ],
    'sql-to-json-converter' => [
        'meta' => [
            'title' => 'SQL to JSON',
            'description' => 'SQL to JSON - Fast, free and reliable online tool.',
            'h1' => 'SQL to JSON',
            'subtitle' => 'Professional SQL to JSON tool',
        ],
        'content' => [
            'about_title' => 'About SQL to JSON',
            'about_p1' => 'SQL to JSON is a powerful utility designed to help you process data efficiently.',
            'what_is_title' => 'What is SQL to JSON?',
    ...
    'uuid-generator' => [
        'meta' => [
            ...
            'h1' => 'UUID Generator',
            'subtitle' => 'The best uuid generator for developers and IT professionals',
        ],
        'content' => [
            'what_is_title' => 'What is UUID Generator?',
            'what_is_desc' => 'This is a free online tool to uuid generator.',
        ],
    ],
    'xml-formatter' => [
        'meta' => [
    ...
    'xml-to-csv' => [
        'meta' => [
            ...
            'description' => 'Free online xml to csv converter tool. Fast, secure and easy to use.',
            'h1' => 'XML to CSV Converter',
            'subtitle' => 'The best xml to csv converter for developers and IT professionals',
        ],
        'content' => [
            'what_is_title' => 'What is XML to CSV Converter?',
            'what_is_desc' => 'This is a free online tool to xml to csv converter.',
        ],
    ],
    'xml-to-json' => [
        'meta' => [
            'title' => 'XML to JSON Converter - Free Online Tool',
            'description' => 'Free online xml to json converter tool. Fast, secure and easy to use.',
            'h1' => 'XML to JSON Converter',
            'subtitle' => 'The best xml to json converter for developers and IT professionals',
        ],
        'content' => [
            'what_is_title' => 'What is XML to JSON Converter?',
            'what_is_desc' => 'This is a free online tool to xml to json converter.',
        ],
    ],
    'yaml-to-json' => [
        'meta' => [
            'title' => 'YAML to JSON Converter - Free Online Tool',
            'description' => 'Convert YAML configuration files to JSON format instantly with our free online YAML to JSON converter. Perfect for developers working with configuration files.',
        ...
        'content' => [
            ...
            'how_to_steps' => [
                ['title' => 'Paste YAML', 'desc' => 'Copy and paste your YAML code into the input area.'],
                ['title' => 'Automatic Conversion', 'desc' => 'The tool converts YAML to JSON in real-time as you type.'],
                ['title' => 'Copy or Download', 'desc' => 'Copy the resulting JSON or download it as a .json file.'],
            ],
            'faq_title' => 'Frequently Asked Questions',
            'faq' => [
                'q1' => 'Is it free?',
                'a1' => 'Yes, our YAML to JSON converter is 100% free.',
                'q2' => 'Is my data secure?',
                'a2' => 'Yes, all conversion happens in your browser. We don\'t store your data.',
            ],
        ],
    ],
];
