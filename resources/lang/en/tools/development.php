...
return array(
  ...
  'file-difference-checker' =>
    array(
      'meta' =>
        array(
          'title' => 'File Difference Checker',
          'description' => 'Compare two text files and find differences instantly',
          'h1' => 'File Difference Checker',
          'subtitle' => 'Compare two text files and find differences instantly',
        ),
      'editor' =>
        array(
          'label_file1' => 'Original File',
          'label_file2' => 'Modified File',
          'ph_file1' => 'Paste first file content here...',
          'ph_file2' => 'Paste second file content here...',
          'btn_compare' => 'Compare Files',
          'btn_clear' => 'Clear',
          'result_label' => 'Differences',
      ...
      'js' =>
        array(
          'error_empty' => 'Please enter content in both text areas to compare',
          'error_same' => 'Both files have identical content',
          'success_compared' => 'Files compared successfully',
        ),
      'content' =>
        array(
          'hero_title' => 'File Difference Checker',
          'hero_subtitle' => 'Compare two text files and find differences instantly',
          'p1' => 'Our free File Difference Checker allows you to compare two text files side-by-side and instantly identify additions, deletions, and modifications. Perfect for developers reviewing code changes, writers comparing document versions, or anyone needing to track text differences.',
          'features_title' => '✨ Key Features',
          'features' =>
            array(
              'visual' =>
                array(
                  'title' => 'Clear Visuals',
                  'desc' => 'Visually highlights additions, deletions, and changes',
                ),
              'instant' =>
                array(
                  'title' => 'Instant Comparison',
                  'desc' => 'Get file difference results and highlights instantly',
                ),
              'privacy' =>
                array(
                  'title' => 'Privacy Focused',
                  'desc' => 'All processing happens in your browser - no data is stored',
                ),
              'unlimited' =>
                array(
                  'title' => 'Unlimited Use',
                  'desc' => 'Compare as many files as you need with no restrictions',
                ),
              'accurate' =>
                array(
                  'title' => 'Accurate Results',
                  'desc' => 'Precisely identifies every difference between files',
                ),
              'free' =>
                array(
                  'title' => '100% Free',
                  'desc' => 'No registration or limits - completely free to use',
                ),
            ),
          'uses_title' => '🎯 Common Use Cases',
          'uses' =>
            array(
              'code' =>
                array(
                  'title' => '💻 Code Review',
                  'desc' => 'Compare different versions of source code to track changes and review modifications',
                ),
              'document' =>
                array(
                  'title' => '📄 Document Comparison',
                  'desc' => 'Compare document versions to see what content has been added, removed, or modified',
                ),
              'config' =>
                array(
                  'title' => '⚙️ Configuration Files',
                  'desc' => 'Check differences in configuration files before deploying changes',
                ),
              'merge' =>
                array(
                  'title' => '� Merge Conflicts',
                  'desc' => 'Identify and resolve merge conflicts when combining code from different branches',
                ),
              'backup' =>
                array(
                  'title' => '💾 Backup Verification',
                  'desc' => 'Verify that backup files match the original or check what has changed',
                ),
              'translation' =>
                array(
                  'title' => '🌐 Translation Files',
                  'desc' => 'Compare translation files across different languages to ensure consistency',
                ),
            ),
          'how_title' => '📚 How to Use',
          'how_steps' =>
            array(
              1 =>
                array(
                  'title' => 'Paste First File',
                  'desc' => 'Copy and paste the original file content into the first text area',
                ),
              2 =>
                array(
                  'title' => 'Paste Second File',
                  'desc' => 'Copy and paste the modified file content into the second text area',
                ),
              3 =>
                array(
                  'title' => 'Click Compare',
                  'desc' => 'Press the "Compare Files" button to analyze differences',
                ),
              4 =>
                array(
                  'title' => 'Review Results',
                  'desc' => 'The tool will highlight additions, deletions, and modifications between the two files',
                ),
            ),
          'faq_title' => '❓ Frequently Asked Questions',
          'faq' =>
            array(
              'q1' => 'What is a file difference checker?',
              'a1' => 'A file difference checker compares two text files and identifies the differences between them, showing additions, deletions, and modifications.',
              'q2' => 'What file types can I compare?',
              'a2' => 'You can compare any text-based files including code files (HTML, CSS, JavaScript, Python), documents, configuration files, and plain text.',
              'q3' => 'Can I compare large files?',
              'a3' => 'Yes, the tool can handle large files. All processing happens in your browser, so performance depends on your device capabilities.',
              'q4' => 'Is my data secure?',
              'a4' => 'Absolutely! All comparisons are performed directly in your browser. Your file contents are never sent to our servers.',
              'q5' => 'Can I use this for code review?',
              'a5' => 'Yes! This tool is perfect for code reviews, comparing different versions of code, and tracking changes in source files.',
            ),
        ),
    ),
);
