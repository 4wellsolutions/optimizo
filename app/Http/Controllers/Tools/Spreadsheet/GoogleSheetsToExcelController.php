...
class GoogleSheetsToExcelController extends Controller
{
    public function index(Request $request)
    {
        $tool = Tool::where('slug', 'google-sheets-to-excel')->firstOrFail();
        return view("tools.spreadsheet.google-sheets-to-excel", compact('tool'));
    }
