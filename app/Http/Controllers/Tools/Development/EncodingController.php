...
class EncodingController extends Controller
{
    ...
    public function asciiConvert()
    {
        ...
        return view('tools.utility.ascii-converter', compact('tool'));
    }
}
